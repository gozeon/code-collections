...
@Component({
  selector: 'app-select-homework',
  templateUrl: './select-homework.component.html',
  styleUrls: ['./select-homework.component.scss']
})
export class SelectHomeworkComponent implements OnInit {
  seasons: any[] = [];
  levels: any[] = [];
  selected = {
    tearmCode: '',
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data: any,
              public dialogRef: MatDialogRef<SelectHomeworkComponent>,
