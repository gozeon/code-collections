(function (f) {
    ...
    return (function e(t, n, r) {
        ...
        1: [function (require, module, exports) {
            ...
            function serializePaintVertexArrays(r, e) {
                ...
                for (var a in r) {
                    ...
                    if (0 !== n.length) {
                        var i = n.serialize(e), s = n.constructor.serialize();
                        t[a] = {array: i, type: s}
                    }
                }
                return t
            ...
            var ProgramConfiguration = require("./program_configuration"), Segment = function (r, e) {
                ...
                for (var y = 0, o = e; y < o.length; y += 1) {
                    var l = o[y], h = ProgramConfiguration.createDynamic(r.paintAttributes || [], l, t);
                    a.layerData[l.id] = {layer: l, programConfiguration: h, paintVertexArray: new h.PaintVertexArray}
                }
        ...
        2: [function (require, module, exports) {
            "use strict";
            var ArrayGroup = require("./array_group"), BufferGroup = require("./buffer_group"), util = require("../util/util"), Bucket = function (r, e) {
            ...
            Bucket.prototype.populate = function (r, e) {
                ...
                if (e) {
                    for (var t = {}, i = 0, u = r; i < u.length; i += 1) {
                        var a = u[i], o = a.layerIds.map(function (r) {
                            return e.getLayer(r)
                        }).filter(Boolean);
                        if (0 !== o.length)for (var s = o[0].createBucket(util.extend({layers: o}, a)), n = 0, f = o; n < f.length; n += 1) {
                            var l = f[n];
                            t[l.id] = s
                        }
                    }
        ...
        }, {"../util/util": 127, "./array_group": 1, "./buffer_group": 9}],
        3: [function (require, module, exports) {
            ...
            var Bucket = require("../bucket"), createVertexArrayType = require("../vertex_array_type"), createElementArrayType = require("../element_array_type"), loadGeometry = require("../load_geometry"), EXTENT = require("../extent"), circleInterface = {
                ...
                return e && (r.__proto__ = e), r.prototype = Object.create(e && e.prototype), r.prototype.constructor = r, r.prototype.addFeature = function (e) {
                    for (var r = this.arrays, t = 0, a = loadGeometry(e); t < a.length; t += 1)for (var p = a[t], c = 0, i = p; c < i.length; c += 1) {
                        var y = i[c], l = y.x, o = y.y;
        ...
        4: [function (require, module, exports) {
            "use strict";
            var Bucket = require("../bucket"), createVertexArrayType = require("../vertex_array_type"), createElementArrayType = require("../element_array_type"), loadGeometry = require("../load_geometry"), earcut = require("earcut"), classifyRings = require("../../util/classify_rings"), EARCUT_MAX_RINGS = 500, fillInterface = {
                layoutVertexArrayType: createVertexArrayType([{
                    name: "a_pos",
                    components: 2,
                    type: "Int16"
                    ...
                    for (var r = this.arrays, t = 0, a = classifyRings(loadGeometry(e), EARCUT_MAX_RINGS); t < a.length; t += 1) {
                        ...
                        for (var i = r.prepareSegment(p), c = i.vertexLength, u = [], h = [], s = 0, g = l; s < g.length; s += 1) {
                            ...
                            if (0 !== m.length) {
                                ...
                                var f = r.prepareSegment2(m.length), A = f.vertexLength;
        ...
        5: [function (require, module, exports) {
            ...
            var Bucket = require("../bucket"), createVertexArrayType = require("../vertex_array_type"), createElementArrayType = require("../element_array_type"), loadGeometry = require("../load_geometry"), EXTENT = require("../extent"), earcut = require("earcut"), classifyRings = require("../../util/classify_rings"), EARCUT_MAX_RINGS = 500, fillExtrusionInterface = {
                layoutVertexArrayType: createVertexArrayType([{
                    name: "a_pos",
                    components: 2,
                    type: "Int16"
        ...
        6: [function (require, module, exports) {
            ...
            var Bucket = require("../bucket"), createVertexArrayType = require("../vertex_array_type"), createElementArrayType = require("../element_array_type"), loadGeometry = require("../load_geometry"), EXTENT = require("../extent"), EXTRUDE_SCALE = 63, COS_HALF_SHARP_CORNER = Math.cos(37.5 * (Math.PI / 180)), SHARP_CORNER_OFFSET = 15, LINE_DISTANCE_BUFFER_BITS = 15, LINE_DISTANCE_SCALE = .5, MAX_LINE_DISTANCE = Math.pow(2, LINE_DISTANCE_BUFFER_BITS - 1) / LINE_DISTANCE_SCALE, lineInterface = {
                layoutVertexArrayType: createVertexArrayType([{
                    name: "a_pos",
                    components: 2,
                    type: "Int16"
                ...
                return e && (t.__proto__ = e), t.prototype = Object.create(e && e.prototype), t.prototype.constructor = t, t.prototype.addFeature = function (e) {
                    ...
                    if (!(e.length < 2)) {
                        "bevel" === r && (a = 1.05);
                        var u = SHARP_CORNER_OFFSET * (EXTENT / (512 * this.overscaling)), l = e[0], p = e[s - 1], o = l.equals(p), c = this.arrays, _ = c.prepareSegment(10 * s);
                        if (2 !== s || !o) {
                            this.distance = 0;
                            var h, y, m, E, x, C, A, f = i, v = o ? "butt" : i, L = !0;
                            this.e1 = this.e2 = this.e3 = -1, o && (h = e[s - 2], x = l.sub(h)._unit()._perp());
                            for (var S = 0; S < s; S++)if (m = o && S === s - 1 ? e[1] : e[S + 1], !m || !e[S].equals(m)) {
                                x && (E = x), h && (y = h), h = e[S], x = m ? m.sub(h)._unit()._perp() : E, E = E || x;
                                var V = E.add(x)._unit(), T = V.x * x.x + V.y * x.y, I = 1 / T, N = T < COS_HALF_SHARP_CORNER && y && m;
                                if (N && S > 0) {
                                    var b = h.dist(y);
                                    if (b > 2 * u) {
                                ...
                                var g = y && m, B = g ? r : m ? f : v;
                                if (g && "round" === B && (I < n ? B = "miter" : I <= 2 && (B = "fakeround")), "miter" === B && I > a && (B = "bevel"), "bevel" === B && (I > 2 && (B = "flipbevel"), I < a && (B = "miter")), y && (d.distance += h.dist(y)), "miter" === B) V._mult(I), d.addCurrentVertex(h, d.distance, V, 0, 0, !1, _); else if ("flipbevel" === B) {
                                    if (I > 100) V = x.clone(); else {
                                        var F = E.x * x.y - E.y * x.x > 0 ? -1 : 1, k = I * E.add(x).mag() / E.sub(x).mag();
                                        V._perp()._mult(k * F)
                                    }
                                    d.addCurrentVertex(h, d.distance, V, 0, 0, !1, _), d.addCurrentVertex(h, d.distance, V.mult(-1), 0, 0, !1, _)
                                } else if ("bevel" === B || "fakeround" === B) {
                                    var D = E.x * x.y - E.y * x.x > 0, U = -Math.sqrt(I * I - 1);
                    ...
                    var s, u = n ? 1 : 0, l = this.arrays, p = l.layoutVertexArray, o = l.elementArray;
        ...
        7: [function (require, module, exports) {
            "use strict";
            function addVertex(e, t, o, a, r, n, i, s, l, y, c) {
                e.emplaceBack(t, o, Math.round(64 * a), Math.round(64 * r), n / 4, i / 4, 10 * (y || 0), c, 10 * (s || 0), 10 * Math.min(l || 25, 25))
            }
            ...
            var Point = require("point-geometry"), ArrayGroup = require("../array_group"), BufferGroup = require("../buffer_group"), createVertexArrayType = require("../vertex_array_type"), createElementArrayType = require("../element_array_type"), EXTENT = require("../extent"), Anchor = require("../../symbol/anchor"), getAnchors = require("../../symbol/get_anchors"), resolveTokens = require("../../util/token"), Quads = require("../../symbol/quads"), Shaping = require("../../symbol/shaping"), resolveText = require("../../symbol/resolve_text"), mergeLines = require("../../symbol/mergelines"), clipLine = require("../../symbol/clip_line"), util = require("../../util/util"), scriptDetection = require("../../util/script_detection"), loadGeometry = require("../load_geometry"), CollisionFeature = require("../../symbol/collision_feature"), findPoleOfInaccessibility = require("../../util/find_pole_of_inaccessibility"), classifyRings = require("../../util/classify_rings"), VectorTileFeature = require("vector-tile").VectorTileFeature, shapeText = Shaping.shapeText, shapeIcon = Shaping.shapeIcon, WritingMode = Shaping.WritingMode, getGlyphQuads = Quads.getGlyphQuads, getIconQuads = Quads.getIconQuads, elementArrayType = createElementArrayType(), layoutVertexArrayType = createVertexArrayType([{
                ...
                icon: {layoutVertexArrayType: layoutVertexArrayType, elementArrayType: elementArrayType},
                collisionBox: {
                    layoutVertexArrayType: createVertexArrayType([{
                        name: "a_pos",
                        components: 2,
            ...
            SymbolBucket.prototype.populate = function (e, t) {
                var o = this, a = this.layers[0].layout, r = a["text-field"], n = a["text-font"], i = a["icon-image"], s = r && n, l = i;
                if (this.features = [], s || l) {
                    for (var y = t.iconDependencies, c = t.glyphDependencies, d = c[n] = c[n] || {}, h = 0; h < e.length; h++) {
                        var x = e[h];
                        if (o.layers[0].filter(x)) {
                            var u;
                            s && (u = resolveText(x, a));
                            var m;
                            if (l && (m = resolveTokens(x.properties, i)), (u || m) && (o.features.push({
                                    text: u,
                                    icon: m,
                                    index: h,
                                ...
                                }), m && (y[m] = !0), u))for (var p = 0; p < u.length; p++)d[u.charCodeAt(p)] = !0
                        }
                    }
                ...
                var r = this.layers[0].layout, n = .5, i = .5;
                ...
                for (var s = "right" === r["text-justify"] ? 1 : "left" === r["text-justify"] ? 0 : .5, l = 24, y = r["text-line-height"] * l, c = "line" !== r["symbol-placement"] ? r["text-max-width"] * l : 0, d = r["text-letter-spacing"] * l, h = [r["text-offset"][0] * l, r["text-offset"][1] * l], x = this.fontstack = r["text-font"].join(","), u = "map" === r["text-rotation-alignment"] && "line" === r["symbol-placement"], m = 0, p = this.features; m < p.length; m += 1) {
                    ...
                    if (f.text) {
                        ...
                        g = {}, g[WritingMode.horizontal] = shapeText(f.text, e[x], c, y, n, i, s, d, h, l, WritingMode.horizontal), g[WritingMode.vertical] = b && u && shapeText(f.text, e[x], c, y, n, i, s, d, h, l, WritingMode.vertical)
                    } else g = {};
                    var I;
                    if (f.icon) {
                        var v = t[f.icon], S = o.layers[0].getLayoutValue("icon-offset", {zoom: o.zoom}, f.properties);
                ...
                var a = this, r = this.layers[0].layout, n = 24, i = this.adjustedTextSize / n, s = void 0 !== this.adjustedTextMaxSize ? this.adjustedTextMaxSize : this.adjustedTextSize, l = this.tilePixelRatio * i, y = this.tilePixelRatio * s / n, c = this.tilePixelRatio * this.adjustedIconSize, d = this.tilePixelRatio * r["symbol-spacing"], h = r["symbol-avoid-edges"], x = r["text-padding"] * this.tilePixelRatio, u = r["icon-padding"] * this.tilePixelRatio, m = r["text-max-angle"] / 180 * Math.PI, p = "map" === r["text-rotation-alignment"] && "line" === r["symbol-placement"], g = "map" === r["icon-rotation-alignment"] && "line" === r["symbol-placement"], f = r["text-allow-overlap"] || r["icon-allow-overlap"] || r["text-ignore-placement"] || r["icon-ignore-placement"], b = r["symbol-placement"], I = d / 2, v = function (r, n) {
                    var i = !(n.x < 0 || n.x > EXTENT || n.y < 0 || n.y > EXTENT);
                    if (!h || i) {
                        var s = i || f;
                        a.addSymbolInstance(n, r, t, o, a.layers[0], s, a.symbolInstancesArray.length, a.collisionBoxArray, e.index, e.sourceLayerIndex, a.index, l, x, p, c, u, g, {zoom: a.zoom}, e.properties)
                    }
                };
                if ("line" === b)for (var S = 0, A = clipLine(e.geometry, 0, 0, EXTENT, EXTENT); S < A.length; S += 1)for (var M = A[S], B = getAnchors(M, d, m, t[WritingMode.vertical] || t[WritingMode.horizontal], o, n, y, a.overscaling, EXTENT), T = 0, z = B; T < z.length; T += 1) {
                    var E = z[T], k = t[WritingMode.horizontal];
                    k && a.anchorIsTooClose(k.text, I, E) || v(M, E)
                } else if ("Polygon" === e.type)for (var P = 0, L = classifyRings(e.geometry, 0); P < L.length; P += 1) {
                    var w = L[P], V = findPoleOfInaccessibility(w, 16);
                    v(w[0], new Anchor(V.x, V.y, 0))
                } else if ("LineString" === e.type)for (var _ = 0, Q = e.geometry; _ < Q.length; _ += 1) {
                    var j = Q[_];
                    v(j, new Anchor(j[0].x, j[0].y, 0))
                } else if ("Point" === e.type)for (var q = 0, C = e.geometry; q < C.length; q += 1)for (var F = C[q], N = 0, W = F; N < W.length; N += 1) {
                    var X = W[N];
                ...
                if (e in a) {
                    for (var r = a[e], n = r.length - 1; n >= 0; n--)if (o.dist(r[n]) < t)return !0
                } else a[e] = [];
                return a[e].push(o), !1
            }, SymbolBucket.prototype.place = function (e, t) {
                var o = this;
                this.createArrays();
                var a = this.layers[0].layout, r = e.maxScale, n = "map" === a["text-rotation-alignment"] && "line" === a["symbol-placement"], i = "map" === a["icon-rotation-alignment"] && "line" === a["symbol-placement"], s = a["text-allow-overlap"] || a["icon-allow-overlap"] || a["text-ignore-placement"] || a["icon-ignore-placement"];
                if (s) {
                    var l = this.symbolInstancesArray.toArray(this.symbolInstancesStartIndex, this.symbolInstancesEndIndex), y = e.angle, c = Math.sin(y), d = Math.cos(y);
                    this.sortedSymbolInstances = l.sort(function (e, t) {
                        var o = c * e.anchorPointX + d * e.anchorPointY | 0, a = c * t.anchorPointX + d * t.anchorPointY | 0;
                        return o - a || t.index - e.index
                    })
                }
                for (var h = this.symbolInstancesStartIndex; h < this.symbolInstancesEndIndex; h++) {
                    var x = o.sortedSymbolInstances ? o.sortedSymbolInstances[h - o.symbolInstancesStartIndex] : o.symbolInstancesArray.get(h), u = {
                    ...
                    }, p = !(x.textBoxStartIndex === x.textBoxEndIndex), g = !(x.iconBoxStartIndex === x.iconBoxEndIndex), f = a["text-optional"] || !p, b = a["icon-optional"] || !g, I = p ? e.placeCollisionFeature(u, a["text-allow-overlap"], a["symbol-avoid-edges"]) : e.minScale, v = g ? e.placeCollisionFeature(m, a["icon-allow-overlap"], a["symbol-avoid-edges"]) : e.minScale;
                    f || b ? !b && I ? I = Math.max(v, I) : !f && v && (v = Math.max(v, I)) : v = I = Math.max(v, I), p && (e.insertCollisionFeature(u, I, a["text-ignore-placement"]), I <= r && o.addSymbols(o.arrays.glyph, x.glyphQuadStartIndex, x.glyphQuadEndIndex, I, a["text-keep-upright"], n, e.angle, x.writingModes)), g && (e.insertCollisionFeature(m, v, a["icon-ignore-placement"]), v <= r && o.addSymbols(o.arrays.icon, x.iconQuadStartIndex, x.iconQuadEndIndex, v, a["icon-keep-upright"], i, e.angle))
                }
                t && this.addToDebugBuffers(e)
            }, SymbolBucket.prototype.addSymbols = function (e, t, o, a, r, n, i, s) {
                for (var l = this, y = e.elementArray, c = e.layoutVertexArray, d = this.zoom, h = Math.max(Math.log(a) / Math.LN2 + d, 0), x = t; x < o; x++) {
                    var u = l.symbolQuadsArray.get(x).SymbolQuad, m = (u.anchorAngle + i + Math.PI) % (2 * Math.PI);
                    if (s & WritingMode.vertical) {
                        if (n && u.writingMode === WritingMode.vertical) {
                            if (r && n && m <= 5 * Math.PI / 4 || m > 7 * Math.PI / 4)continue
                        } else if (r && n && m <= 3 * Math.PI / 4 || m > 5 * Math.PI / 4)continue
                    } else if (r && n && (m <= Math.PI / 2 || m > 3 * Math.PI / 2))continue;
                    var p = u.tl, g = u.tr, f = u.bl, b = u.br, I = u.tex, v = u.anchorPoint, S = Math.max(d + Math.log(u.minScale) / Math.LN2, h), A = Math.min(d + Math.log(u.maxScale) / Math.LN2, 25);
                    if (!(A <= S)) {
                        S === h && (S = 0);
                        var M = Math.round(u.glyphAngle / (2 * Math.PI) * 256), B = e.prepareSegment(4), T = B.vertexLength;
                        addVertex(c, v.x, v.y, p.x, p.y, I.x, I.y, S, A, h, M), addVertex(c, v.x, v.y, g.x, g.y, I.x + I.w, I.y, S, A, h, M), addVertex(c, v.x, v.y, f.x, f.y, I.x, I.y + I.h, S, A, h, M), addVertex(c, v.x, v.y, b.x, b.y, I.x + I.w, I.y + I.h, S, A, h, M), y.emplaceBack(T, T + 1, T + 2), y.emplaceBack(T + 1, T + 2, T + 3), B.vertexLength += 4, B.primitiveLength += 2
                    }
                }
            }, SymbolBucket.prototype.addToDebugBuffers = function (e) {
                for (var t = this, o = this.arrays.collisionBox, a = o.layoutVertexArray, r = o.elementArray, n = -e.angle, i = e.yStretch, s = this.symbolInstancesStartIndex; s < this.symbolInstancesEndIndex; s++) {
                    var l = t.symbolInstancesArray.get(s);
                    l.textCollisionFeature = {
                        boxStartIndex: l.textBoxStartIndex,
                        boxEndIndex: l.textBoxEndIndex
                    }, l.iconCollisionFeature = {boxStartIndex: l.iconBoxStartIndex, boxEndIndex: l.iconBoxEndIndex};
                    for (var y = 0; y < 2; y++) {
                        var c = l[0 === y ? "textCollisionFeature" : "iconCollisionFeature"];
                        if (c)for (var d = c.boxStartIndex; d < c.boxEndIndex; d++) {
                            var h = t.collisionBoxArray.get(d), x = h.anchorPoint, u = new Point(h.x1, h.y1 * i)._rotate(n), m = new Point(h.x2, h.y1 * i)._rotate(n), p = new Point(h.x1, h.y2 * i)._rotate(n), g = new Point(h.x2, h.y2 * i)._rotate(n), f = Math.max(0, Math.min(25, t.zoom + Math.log(h.maxScale) / Math.LN2)), b = Math.max(0, Math.min(25, t.zoom + Math.log(h.placementScale) / Math.LN2)), I = o.prepareSegment(4), v = I.vertexLength;
            ...
            }, SymbolBucket.prototype.addSymbolInstance = function (e, t, o, a, r, n, i, s, l, y, c, d, h, x, u, m, p, g, f) {
                var b, I, v, S = this, A = [];
                for (var M in o) {
                    var B = parseInt(M, 10);
                    o[B] && (A = A.concat(n ? getGlyphQuads(e, o[B], d, t, r, x, B) : []), b = new CollisionFeature(s, t, e, l, y, c, o[B], d, h, x, !1))
                }
                var T = this.symbolQuadsArray.length;
                if (A && A.length)for (var z = 0; z < A.length; z++)S.addSymbolQuad(A[z]);
                var E = this.symbolQuadsArray.length, k = b ? b.boxStartIndex : this.collisionBoxArray.length, P = b ? b.boxEndIndex : this.collisionBoxArray.length;
                a && (v = n ? getIconQuads(e, a, u, t, r, p, o[WritingMode.horizontal], g, f) : [], I = new CollisionFeature(s, t, e, l, y, c, a, u, m, p, !0));
                var L = this.symbolQuadsArray.length;
                v && 1 === v.length && this.addSymbolQuad(v[0]);
                var w = this.symbolQuadsArray.length, V = I ? I.boxStartIndex : this.collisionBoxArray.length, _ = I ? I.boxEndIndex : this.collisionBoxArray.length;
                w > SymbolBucket.MAX_QUADS && util.warnOnce("Too many symbols being rendered in a tile. See https://github.com/mapbox/mapbox-gl-js/issues/2907"), E > SymbolBucket.MAX_QUADS && util.warnOnce("Too many glyphs being rendered in a tile. See https://github.com/mapbox/mapbox-gl-js/issues/2907");
                var Q = (o[WritingMode.vertical] ? WritingMode.vertical : 0) | (o[WritingMode.horizontal] ? WritingMode.horizontal : 0);
                return this.symbolInstancesArray.emplaceBack(k, P, V, _, T, E, L, w, e.x, e.y, i, Q)
            ...
            "../../symbol/anchor": 73,
            "../../symbol/clip_line": 75,
            "../../symbol/collision_feature": 77,
            "../../symbol/get_anchors": 79,
            "../../symbol/mergelines": 82,
            "../../symbol/quads": 83,
            "../../symbol/resolve_text": 84,
            "../../symbol/shaping": 85,
            "../../util/classify_rings": 111,
            "../../util/find_pole_of_inaccessibility": 117,
            "../../util/script_detection": 124,
            "../../util/token": 126,
            "../../util/util": 127,
            "../array_group": 1,
            "../buffer_group": 9,
        ...
        9: [function (require, module, exports) {
            "use strict";
            var util = require("../util/util"), Buffer = require("./buffer"), ProgramConfiguration = require("./program_configuration"), VertexArrayObject = require("../render/vertex_array_object"), BufferGroup = function (e, r, t, a) {
                var f = this;
                ...
                for (var i = 0, n = r; i < n.length; i += 1) {
                    var u = n[i], s = a.paintVertexArrays && a.paintVertexArrays[u.id], o = ProgramConfiguration.createDynamic(e.paintAttributes || [], u, t), y = s ? new Buffer(s.array, s.type, Buffer.BufferType.VERTEX) : null;
                    f.layerData[u.id] = {programConfiguration: o, paintVertexBuffer: y}
                }
                this.segments = a.segments, this.segments2 = a.segments2;
                for (var l = 0, m = [this.segments, this.segments2]; l < m.length; l += 1)for (var B = m[l], h = 0, p = B || []; h < p.length; h += 1) {
                    var g = p[h];
            ...
            BufferGroup.prototype.destroy = function () {
                ...
                for (var a = 0, f = [this.segments, this.segments2]; a < f.length; a += 1)for (var i = f[a], n = 0, u = i || []; n < u.length; n += 1) {
                    var s = u[n];
                    for (var o in s.vaos)s.vaos[o].destroy()
                }
            }, module.exports = BufferGroup;
        }, {"../render/vertex_array_object": 39, "../util/util": 127, "./buffer": 8, "./program_configuration": 15}],
        ...
        12: [function (require, module, exports) {
            ...
            function offsetLine(e, t) {
                for (var r = [], i = new Point(0, 0), n = 0; n < e.length; n++) {
                    for (var a = e[n], o = [], s = 0; s < a.length; s++) {
                        var l = a[s - 1], u = a[s], c = a[s + 1], y = 0 === s ? i : u.sub(l)._unit()._perp(), f = s === a.length - 1 ? i : c.sub(u)._unit()._perp(), d = y._add(f)._unit(), h = d.x * f.x + d.y * f.y;
            ...
            FeatureIndex.prototype.insert = function (e, t) {
                ...
                }), f = 1 / 0, d = 1 / 0, h = -(1 / 0), g = -(1 / 0), p = 0; p < y.length; p++)for (var v = y[p], x = 0; x < v.length; x++) {
                    var I = v[x];
                ...
                for (var u, c = this, y = 0; y < t.length; y++) {
                    ...
                    if (f !== u) {
                        u = f;
                        var d = r.get(f), h = c.bucketLayerIDs[d.bucketIndex];
                        if (!a || arraysIntersect(a, h)) {
                            var g = c.sourceLayerCoder.decode(d.sourceLayerIndex), p = c.vtLayers[g], v = p.feature(d.featureIndex);
                            if (n(v))for (var x = null, I = 0; I < h.length; I++) {
                                var m = h[I];
                                if (!(a && a.indexOf(m) < 0)) {
                                    var L = o[m];
                                    if (L) {
            ...
            "../util/dictionary_coder": 113,
            "../util/intersection_tests": 120,
            "../util/struct_array": 125,
            "../util/util": 127,
            "../util/vectortile_to_geojson": 128,
            "./extent": 11,
            "./load_geometry": 13,
            "feature-filter": 135,
            "grid-index": 146,
        ...
        13: [function (require, module, exports) {
            ...
            var util = require("../util/util"), EXTENT = require("./extent"), boundsLookup = {
                15: createBounds(15),
                16: createBounds(16)
            };
        ...
        }, {"../util/util": 127, "./extent": 11}],
        14: [function (require, module, exports) {
            "use strict";
            var createStructArrayType = require("../util/struct_array"), PosArray = createStructArrayType({
                members: [{
                    name: "a_pos",
                    type: "Int16",
                    components: 2
        ...
        15: [function (require, module, exports) {
            ...
            function getPaintAttributeValue(t, e, r, i) {
                ...
                var a = t.zoomStops.map(function (a) {
                    return e.getPaintValue(t.property, util.extend({}, r, {zoom: a}), i)
                });
                return 1 === a.length ? a[0] : a
            }

            function normalizePaintAttribute(t, e) {
                var r = t.property.replace(e.type + "-", "").replace(/-/g, "_"), i = "color" === e._paintSpecifications[t.property].type;
                return util.extend({name: "a_" + r, components: i ? 4 : 1, multiplier: i ? 255 : 1}, t)
            }

            var createVertexArrayType = require("./vertex_array_type"), util = require("../util/util"), ProgramConfiguration = function () {
            ...
            ProgramConfiguration.createDynamic = function (t, e, r) {
                for (var i = new ProgramConfiguration, a = 0, n = t; a < n.length; a += 1) {
                    var o = n[a], p = normalizePaintAttribute(o, e), u = p.name.slice(2);
                ...
                if (1 === e.components) this.attributes.push(util.extend({}, e, {
                    components: 4,
                    zoomStops: m
                })), n.vertex.define.push("attribute {precision} vec4 " + e.name + ";"), g.push(e.name); else for (var h = 0; h < 4; h++) {
                    var l = e.name + h;
                ...
                var n = e.length;
                e.resize(r);
                for (var o = 0, p = this.attributes; o < p.length; o += 1)for (var u = p[o], s = getPaintAttributeValue(u, t, i, a), m = n; m < r; m++) {
                    var f = e.get(m);
                    if (4 === u.components)for (var g = 0; g < 4; g++)f[u.name + g] = s[g] * u.multiplier; else f[u.name] = s * u.multiplier
                }
            }, ProgramConfiguration.prototype.setUniforms = function (t, e, r, i) {
                for (var a = 0, n = this.uniforms; a < n.length; a += 1) {
                    var o = n[a], p = r.getPaintValue(o.property, i);
                    4 === o.components ? t.uniform4fv(e[o.name], p) : t.uniform1f(e[o.name], p)
                }
                for (var u = 0, s = this.interpolationUniforms; u < s.length; u += 1) {
                    var m = s[u], f = r.getPaintInterpolationT(m.property, i);
                    t.uniform1f(e[m.name], Math.max(0, Math.min(4, f - m.stopOffset)))
                }
            }, module.exports = ProgramConfiguration;
        }, {"../util/util": 127, "./vertex_array_type": 17}],
        16: [function (require, module, exports) {
            "use strict";
            var createStructArrayType = require("../util/struct_array"), RasterBoundsArray = createStructArrayType({
                members: [{
                    name: "a_pos",
                    type: "Int16",
                    components: 2
        ...
        21: [function (require, module, exports) {
            "use strict";
            var LngLat = require("./lng_lat"), Point = require("point-geometry"), Coordinate = require("./coordinate"), util = require("../util/util"), interp = require("../util/interpolate"), TileCoord = require("../source/tile_coord"), EXTENT = require("../data/extent"), glmatrix = require("@mapbox/gl-matrix"), vec4 = glmatrix.vec4, mat4 = glmatrix.mat4, mat2 = glmatrix.mat2, Transform = function (t, i) {
                this.tileSize = 512, this._minZoom = t || 0, this._maxZoom = i || 22, this.latRange = [-85.05113, 85.05113], this.width = 0, this.height = 0, this._center = new LngLat(0, 0), this.zoom = 0, this.angle = 0, this._fov = .6435011087932844, this._pitch = 0, this._unmodified = !0
            }, prototypeAccessors = {
                minZoom: {},
                maxZoom: {},
                worldSize: {},
            ...
            prototypeAccessors.minZoom.get = function () {
                ...
                var e = this.pointCoordinate(this.centerPoint, i), r = new Point(e.column - .5, e.row - .5), n = [this.pointCoordinate(new Point(0, 0), i), this.pointCoordinate(new Point(this.width, 0), i), this.pointCoordinate(new Point(this.width, this.height), i), this.pointCoordinate(new Point(0, this.height), i)];
                return TileCoord.cover(i, n, t.reparseOverscaled ? o : i).sort(function (t, i) {
                ...
                var n = e[3], s = r[3], a = e[0] / n, h = r[0] / s, c = e[1] / n, m = r[1] / s, p = e[2] / n, l = r[2] / s, u = p === l ? 0 : (o - p) / (l - p);
                ...
                var o = t.toCoordinate(i), e = this.worldSize / this.zoomScale(o.zoom), r = mat4.identity(new Float64Array(16));
                ...
                if (this.height) {
                    ...
                    var t = this._fov / 2, i = Math.PI / 2 + this._pitch, o = Math.sin(t) * this.cameraToCenterDistance / Math.sin(Math.PI - i - t), e = Math.cos(Math.PI / 2 - this._pitch) * o + this.cameraToCenterDistance, r = 1.01 * e, n = new Float64Array(16);
            ...
            "../data/extent": 11,
            "../source/tile_coord": 51,
            "../util/interpolate": 119,
            "../util/util": 127,
            "./coordinate": 18,
            "./lng_lat": 19,
            "@mapbox/gl-matrix": 131,
            "point-geometry": 194
        }],
        22: [function (require, module, exports) {
            "use strict";
            var WorkerPool = require("./util/worker_pool"), globalWorkerPool;
            module.exports = function () {
                return globalWorkerPool || (globalWorkerPool = new WorkerPool), globalWorkerPool
            };
        }, {"./util/worker_pool": 130}],
        23: [function (require, module, exports) {
            ...
            module.exports = function (l, n, t, e) {
                ...
                for (r = 0, o = l.length; r < o; r++)if (i = simplexFont[l[r]]) {
        ...
        24: [function (require, module, exports) {
            ...
            "./style/style": 61,
            "./ui/control/attribution_control": 91,
            "./ui/control/geolocate_control": 92,
            "./ui/control/navigation_control": 93,
            "./ui/control/scale_control": 94,
            "./ui/map": 103,
            "./ui/marker": 104,
            "./ui/popup": 105,
            "./util/ajax": 107,
        ...
        25: [function (require, module, exports) {
            ...
            function drawBackground(r, t, e) {
                var a = r.gl, i = r.transform, n = i.tileSize, o = e.paint["background-color"], l = e.paint["background-pattern"], u = e.paint["background-opacity"], f = !l && 1 === o[3] && 1 === u;
                if (r.isOpaquePass === f) {
            ...
            function drawCircles(e, r, t, a) {
                if (!e.isOpaquePass) {
                    ...
                    for (var s = 0; s < a.length; s++) {
                        ...
                        if (f) {
                            var l = f.buffers, m = l.layerData[t.id], u = m.programConfiguration, c = e.useProgram("circle", u);
        ...
        28: [function (require, module, exports) {
            ...
            function drawDebugTile(r, e, a) {
                ...
                var l = Buffer.fromStructArray(f, Buffer.BufferType.VERTEX), b = new VertexArrayObject;
                b.bind(t, u, l), t.uniform4f(u.u_color, 1, 1, 1, 1);
                for (var d = e.getTile(a).tileSize, g = EXTENT / (Math.pow(2, r.transform.zoom - a.z) * d), m = [[-1, -1], [-1, 1], [1, -1], [1, 1]], s = 0; s < m.length; s++) {
                    var x = m[s];
            ...
            var textVertices = require("../lib/debugtext"), browser = require("../util/browser"), mat4 = require("@mapbox/gl-matrix").mat4, EXTENT = require("../data/extent"), Buffer = require("../data/buffer"), VertexArrayObject = require("./vertex_array_object"), PosArray = require("../data/pos_array");
        ...
        29: [function (require, module, exports) {
            ...
            function drawStrokeTile(t, e, r, i, a, l, n) {
                var o = t.gl, f = l.layerData[r.id], s = r.paint["fill-pattern"] && !r.getPaintProperty("fill-outline-color"), u = setFillProgram("fillOutline", s, t, f, r, i, a, n);
        ...
        30: [function (require, module, exports) {
            ...
            function drawExtrusion(t, e, r, i) {
                if (!t.isOpaquePass) {
                    ...
                    if (s) {
                        var u = s.buffers, f = t.gl, h = r.paint["fill-extrusion-pattern"], n = u.layerData[r.id], o = n.programConfiguration, E = t.useProgram(h ? "fillExtrusionPattern" : "fillExtrusion", o);
            ...
            function setLight(t, e) {
                var r = e.gl, i = e.style.light, a = i.calculated.position, s = [a.x, a.y, a.z], u = mat3.create();
            ...
            var glMatrix = require("@mapbox/gl-matrix"), Buffer = require("../data/buffer"), VertexArrayObject = require("./vertex_array_object"), PosArray = require("../data/pos_array"), pattern = require("./pattern"), mat3 = glMatrix.mat3, mat4 = glMatrix.mat4, vec3 = glMatrix.vec3;
        ...
        31: [function (require, module, exports) {
            ...
            var browser = require("../util/browser"), pixelsToTileUnits = require("../source/pixels_to_tile_units");
            module.exports = function (e, i, t, r) {
                if (!e.isOpaquePass) {
                    e.setDepthSublayer(0), e.depthMask(!1);
                    var a = e.gl;
                    if (a.enable(a.STENCIL_TEST), !(t.paint["line-width"] <= 0))for (var n, o = t.paint["line-dasharray"] ? "lineSDF" : t.paint["line-pattern"] ? "linePattern" : "line", f = !0, s = 0, l = r; s < l.length; s += 1) {
                        var u = l[s], m = i.getTile(u), _ = m.getBucket(t);
                        if (_) {
                            var p = _.buffers.layerData[t.id], g = e.currentProgram, d = e.useProgram(o, p.programConfiguration), v = f || d !== g, T = n !== m.coord.z;
        ...
        }, {"../source/pixels_to_tile_units": 45, "../util/browser": 108}],
        32: [function (require, module, exports) {
            ...
            function drawRasterTile(r, t, a, e) {
                ...
                var o = t.getTile(e), n = r.transform.calculatePosMatrix(e, t.getSource().maxzoom);
                ...
                var s, c, f = o.sourceCache && o.sourceCache.findLoadedParent(e, 0, {}), d = getOpacities(o, f, a, r.transform);
                i.activeTexture(i.TEXTURE0), i.bindTexture(i.TEXTURE_2D, o.texture), i.activeTexture(i.TEXTURE1), f ? (i.bindTexture(i.TEXTURE_2D, f.texture), s = Math.pow(2, f.coord.z - o.coord.z), c = [o.coord.x * s % 1, o.coord.y * s % 1]) : i.bindTexture(i.TEXTURE_2D, o.texture), i.uniform2fv(u.u_tl_parent, c || [0, 0]), i.uniform1f(u.u_scale_parent, s || 1), i.uniform1f(u.u_buffer_scale, 1), i.uniform1f(u.u_opacity0, d[0]), i.uniform1f(u.u_opacity1, d[1]), i.uniform1i(u.u_image0, 0), i.uniform1i(u.u_image1, 1);
                var m = o.boundsBuffer || r.rasterBoundsBuffer, h = o.boundsVAO || r.rasterBoundsVAO;
            ...
            function getOpacities(r, t, a, e) {
                var i = [1, 0], o = a.paint["raster-fade-duration"];
                if (r.sourceCache && o > 0) {
                    var n = Date.now(), u = (n - r.timeAdded) / o, s = t ? (n - t.timeAdded) / o : -1, c = r.sourceCache.getSource(), f = e.coveringZoomLevel({
                        tileSize: c.tileSize,
                        roundZoom: c.roundZoom
                    }), d = !t || Math.abs(t.coord.z - f) > Math.abs(r.coord.z - f);
                    i[0] = util.clamp(d ? u : 1 - s, 0, 1), i[1] = t ? 1 - i[0] : 0
                }
                var m = a.paint["raster-opacity"];
                return i[0] *= m, i[1] *= m, i
            }
        ...
        33: [function (require, module, exports) {
            ...
            function drawLayerSymbols(t, e, i, a, o, r, n, l, s, u, f, m, p, c, d) {
                if (o || !t.style.sprite || t.style.sprite.loaded()) {
                    var h = t.gl, b = "map" === l, x = "map" === s, g = x;
                    g ? h.enable(h.DEPTH_TEST) : h.disable(h.DEPTH_TEST);
                    for (var _, y = 0, T = a; y < T.length; y += 1) {
                        var v = T[y], w = e.getTile(v), S = w.getBucket(i);
                        if (S) {
                            var E = o ? S.buffers.glyph : S.buffers.icon;
                            if (E && E.segments.length) {
                                var P = o || S.sdfIcons;
                                _ || (_ = t.useProgram(P ? "symbolSDF" : "symbolIcon"), setSymbolDrawState(_, t, o, P, b, x, S.fontstack, u, S.iconsNeedLinear, o ? S.adjustedTextSize : S.adjustedIconSize, c)), t.enableTileClippingMask(v), h.uniformMatrix4fv(_.u_matrix, !1, t.translatePosMatrix(v.posMatrix, w, r, n)), drawTileSymbols(_, t, i, w, E, o, P, x, u, f, m, p, d)
                            }
                        }
                    }
            ...
            function setSymbolDrawState(t, e, i, a, o, r, n, l, s, u, f) {
                ...
                if (m.uniform1i(t.u_rotate_with_map, o), m.uniform1i(t.u_pitch_with_map, r), m.activeTexture(m.TEXTURE0), m.uniform1i(t.u_texture, 0), i) {
                    var c = n && e.glyphSource.getGlyphAtlas(n);
                    if (!c)return;
                    c.updateTexture(m), m.uniform2f(t.u_texsize, c.width / 4, c.height / 4)
                } else {
                    var d = e.options.rotating || e.options.zooming, h = 1 !== l || browser.devicePixelRatio !== e.spriteAtlas.pixelRatio || s, b = r || p.pitch;
                ...
                m.uniform1f(t.u_zoom, 10 * (p.zoom - x)), m.uniform1f(t.u_pitch, p.pitch / 360 * 2 * Math.PI), m.uniform1f(t.u_bearing, p.bearing / 360 * 2 * Math.PI), m.uniform1f(t.u_aspect_ratio, p.width / p.height), m.uniform1f(t.u_opacity, f)
            }

            function drawTileSymbols(t, e, i, a, o, r, n, l, s, u, f, m, p) {
                var c = e.gl, d = e.transform, h = s / (r ? 24 : 1);
                if (l) {
                    var b = pixelsToTileUnits(a, h, d.zoom);
                    c.uniform2f(t.u_extrude_scale, b, b)
                } else {
                    var x = d.cameraToCenterDistance * h;
                    c.uniform2f(t.u_extrude_scale, d.pixelsToGLUnits[0] * x, d.pixelsToGLUnits[1] * x)
                }
                if (n) {
                    var g = h * (l ? Math.cos(d._pitch) : 1) * d.cameraToCenterDistance;
                    u && (c.uniform1f(t.u_gamma, (m * blurOffset / sdfPx + gamma) / g), c.uniform4fv(t.u_color, f), c.uniform1f(t.u_buffer, (haloOffset - u / h) / sdfPx), drawSymbolElements(o, i, c, t)), c.uniform1f(t.u_gamma, gamma / g), c.uniform4fv(t.u_color, p), c.uniform1f(t.u_buffer, .75)
                }
                drawSymbolElements(o, i, c, t)
            }
            ...
            var sdfPx = 8, blurOffset = 1.19, haloOffset = 6, gamma = .105 / browser.devicePixelRatio;
        }, {"../source/pixels_to_tile_units": 45, "../util/browser": 108, "./draw_collision_debug": 27}],
        ...
        35: [function (require, module, exports) {
            ...
            LineAtlas.prototype.setSprite = function (t) {
                ...
                for (var E = this.width / r, o = E / 2, T = t.length % 2 === 1, R = -h; R <= h; R++)for (var u = e.nextRow + h + R, d = e.width * u, l = T ? -t[t.length - 1] : 0, x = t[0], A = 1, _ = 0; _ < this.width; _++) {
                    for (; x < _ / E;)l = x, x += t[A], T && A === t.length - 1 && (x += t[0]), A++;
                    var p, g = Math.abs(_ - l * E), w = Math.abs(_ - x * E), D = Math.min(g, w), U = A % 2 === 1;
                    if (i) {
                        var f = h ? R / h * (o + 1) : 0;
                        if (U) {
                            var X = o - Math.abs(f);
                ...
                var y = {y: (this.nextRow + h + .5) / this.height, height: 2 * h / this.height, width: r};
        ...
        36: [function (require, module, exports) {
            "use strict";
            var browser = require("../util/browser"), mat4 = require("@mapbox/gl-matrix").mat4, FrameHistory = require("./frame_history"), SourceCache = require("../source/source_cache"), EXTENT = require("../data/extent"), pixelsToTileUnits = require("../source/pixels_to_tile_units"), util = require("../util/util"), Buffer = require("../data/buffer"), VertexArrayObject = require("./vertex_array_object"), RasterBoundsArray = require("../data/raster_bounds_array"), PosArray = require("../data/pos_array"), ProgramConfiguration = require("../data/program_configuration"), shaders = require("./shaders"), draw = {
            ...
            Painter.prototype.resize = function (e, r) {
                ...
                var a = new RasterBoundsArray;
                a.emplaceBack(0, 0, 0, 0), a.emplaceBack(EXTENT, 0, 32767, 0), a.emplaceBack(0, EXTENT, 0, 32767), a.emplaceBack(EXTENT, EXTENT, 32767, 32767), this.rasterBoundsBuffer = Buffer.fromStructArray(a, Buffer.BufferType.VERTEX), this.rasterBoundsVAO = new VertexArrayObject
                ...
                for (var i = 0, s = e; i < s.length; i += 1) {
                    var o = s[i], n = r._tileClippingMaskIDs[o.id] = a++ << 3;
                ...
                if (this.style = e, this.options = r, this.lineAtlas = e.lineAtlas, this.spriteAtlas = e.spriteAtlas, this.spriteAtlas.setSprite(e.sprite), this.glyphSource = e.glyphSource, this.frameHistory.record(Date.now(), this.transform.zoom, e.getTransition().duration), this.prepareBuffers(), this.clearColor(), this.clearDepth(), this.showOverdrawInspector(r.showOverdrawInspector), this.depthRange = (e._order.length + 2) * this.numSublayers * this.depthEpsilon, this.isOpaquePass = !0, this.renderPass(), this.isOpaquePass = !1, this.renderPass(), this.options.showTileBoundaries) {
                    ...
                    draw.debug(this, t, t.getVisibleCoordinates())
                }
            }, Painter.prototype.renderPass = function () {
                var e, r, t = this, a = this.style._order;
                this.currentLayer = this.isOpaquePass ? a.length - 1 : 0;
                for (var i = 0; i < a.length; i++) {
                    var s = t.style._layers[a[t.currentLayer]];
                    s.source !== (e && e.id) && (e = t.style.sourceCaches[s.source], r = [], e && (e.prepare && e.prepare(), t.clearStencil(), r = e.getVisibleCoordinates(), e.getSource().isTileClipped && t._renderTileClippingMasks(r)), t.isOpaquePass ? t._showOverdrawInspector || t.gl.disable(t.gl.BLEND) : (t.gl.enable(t.gl.BLEND), r.reverse())), t.renderLayer(t, e, s, r), t.currentLayer += t.isOpaquePass ? -1 : 1
                }
            }, Painter.prototype.depthMask = function (e) {
                e !== this._depthMask && (this._depthMask = e, this.gl.depthMask(e))
            }, Painter.prototype.renderLayer = function (e, r, t, a) {
                t.isHidden(this.transform.zoom) || ("background" === t.type || a.length) && (this.id = t.id, draw[t.type](e, r, t, a))
            ...
            }, Painter.prototype.translatePosMatrix = function (e, r, t, a) {
                if (!t[0] && !t[1])return e;
                if ("viewport" === a) {
                    var i = Math.sin(-this.transform.angle), s = Math.cos(-this.transform.angle);
                    t = [t[0] * s - t[1] * i, t[0] * i + t[1] * s]
                }
                var o = [pixelsToTileUnits(r, t[0], this.transform.zoom), pixelsToTileUnits(r, t[1], this.transform.zoom), 0], n = new Float32Array(16);
                ...
                this.reusableTextures.viewport || (this.reusableTextures.viewport = {}), this.reusableTextures.viewport.texture = e
            }, Painter.prototype.getTileTexture = function (e, r) {
                var t = this.reusableTextures[e];
                if (t) {
                    var a = t[r || e];
                ...
                if (this.reusableTextures.viewport) {
                    var t = this.reusableTextures.viewport.texture;
                    return t.width === e && t.height === r ? t : (this.gl.deleteTexture(t), void(this.reusableTextures.viewport.texture = null))
                }
                ...
                if (e || this._showOverdrawInspector) {
                    ...
                    if (e) {
                        ...
                        var t = 8, a = 1 / t;
                        r.blendColor(a, a, a, 0), r.clearColor(0, 0, 0, 1), r.clear(r.COLOR_BUFFER_BIT)
                    } else r.blendFunc(r.ONE, r.ONE_MINUS_SRC_ALPHA)
                }
            }, Painter.prototype.createProgram = function (e, r) {
                var t = this.gl, a = t.createProgram(), i = shaders[e], s = "#define MAPBOX_GL_JS\n#define DEVICE_PIXEL_RATIO " + browser.devicePixelRatio.toFixed(1) + "\n";
                this._showOverdrawInspector && (s += "#define OVERDRAW_INSPECTOR;\n");
                var o = t.createShader(t.FRAGMENT_SHADER);
                t.shaderSource(o, r.applyPragmas(s + shaders.prelude.fragmentSource + i.fragmentSource, "fragment")), t.compileShader(o), t.attachShader(a, o);
                var n = t.createShader(t.VERTEX_SHADER);
                t.shaderSource(n, r.applyPragmas(s + shaders.prelude.vertexSource + i.vertexSource, "vertex")), t.compileShader(n), t.attachShader(a, n), t.linkProgram(a);
                for (var l = t.getProgramParameter(a, t.ACTIVE_ATTRIBUTES), u = {
                    program: a,
                    numAttributes: l
                }, h = 0; h < l; h++) {
                    var c = t.getActiveAttrib(a, h);
                    u[c.name] = t.getAttribLocation(a, c.name)
                }
                for (var p = t.getProgramParameter(a, t.ACTIVE_UNIFORMS), d = 0; d < p; d++) {
                    var f = t.getActiveUniform(a, d);
                    u[f.name] = t.getUniformLocation(a, f.name)
                }
                return u
                ...
                var t = this.gl, a = this._createProgramCached(e, r || this.emptyProgramConfiguration);
                return this.currentProgram !== a && (t.useProgram(a.program), this.currentProgram = a), a
            ...
            "../source/pixels_to_tile_units": 45,
            "../source/source_cache": 49,
            "../util/browser": 108,
            "../util/util": 127,
            "./draw_background": 25,
            "./draw_circle": 26,
        ...
        37: [function (require, module, exports) {
            ...
            exports.prepare = function (r, t, i) {
                var o = t.gl, e = t.spriteAtlas.getPosition(r.from, !0), _ = t.spriteAtlas.getPosition(r.to, !0);
                ...
                var e = Math.pow(2, r.coord.z), _ = r.tileSize * Math.pow(2, t.transform.tileZoom) / e, u = _ * (r.coord.x + r.coord.w * e), n = _ * r.coord.y;
        ...
        40: [function (require, module, exports) {
            ...
            var Evented = require("../util/evented"), util = require("../util/util"), window = require("../util/window"), EXTENT = require("../data/extent"), GeoJSONSource = function (t) {
                function e(e, o, i, r) {
                    var a = this;
                    t.call(this), o = o || {}, this.id = e, this.type = "geojson", this.minzoom = 0, this.maxzoom = 18, this.tileSize = 512, this.isTileClipped = !0, this.reparseOverscaled = !0, this.dispatcher = i, this._data = o.data, void 0 !== o.maxzoom && (this.maxzoom = o.maxzoom), o.type && (this.type = o.type);
                    ...
                    }, o.workerOptions), this.setEventedParent(r), this.fire("dataloading", {dataType: "source"}), this._updateWorkerData(function (t) {
                        return t ? void a.fire("error", {error: t}) : (a.fire("data", {dataType: "source"}), void a.fire("source.load"))
                    })
                }

                return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.onAdd = function (t) {
                    this.map = t
                }, e.prototype.setData = function (t) {
                    var e = this;
                    return this._data = t, this.fire("dataloading", {dataType: "source"}), this._updateWorkerData(function (t) {
                        return t ? e.fire("error", {error: t}) : void e.fire("data", {dataType: "source"})
                    }), this
        ...
        }, {"../data/extent": 11, "../util/evented": 116, "../util/util": 127, "../util/window": 110}],
        41: [function (require, module, exports) {
            "use strict";
            var ajax = require("../util/ajax"), rewind = require("geojson-rewind"), GeoJSONWrapper = require("./geojson_wrapper"), vtpbf = require("vt-pbf"), supercluster = require("supercluster"), geojsonvt = require("geojson-vt"), VectorTileWorkerSource = require("./vector_tile_worker_source"), GeoJSONWorkerSource = function (e) {
                function r(r, t, o) {
        ...
        42: [function (require, module, exports) {
            "use strict";
            var Point = require("point-geometry"), VectorTileFeature = require("vector-tile").VectorTileFeature, EXTENT = require("../data/extent"), FeatureWrapper = function (e) {
                var t = this;
        ...
        }, {"../data/extent": 11, "point-geometry": 194, "vector-tile": 204}],
        43: [function (require, module, exports) {
            "use strict";
            var util = require("../util/util"), window = require("../util/window"), TileCoord = require("./tile_coord"), LngLat = require("../geo/lng_lat"), Point = require("point-geometry"), Evented = require("../util/evented"), ajax = require("../util/ajax"), EXTENT = require("../data/extent"), RasterBoundsArray = require("../data/raster_bounds_array"), Buffer = require("../data/buffer"), VertexArrayObject = require("../render/vertex_array_object"), ImageSource = function (t) {
                function e(e, r, o, i) {
                    t.call(this), this.id = e, this.dispatcher = o, this.coordinates = r.coordinates, this.minzoom = 0, this.maxzoom = 22, this.tileSize = 512, this.setEventedParent(i), this.fire("dataloading", {dataType: "source"}), this._load(r)
                }

                return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype._load = function (t) {
                    var e = this;
                    this.url = t.url, ajax.getImage(t.url, function (t, r) {
                        return t ? e.fire("error", {error: t}) : (e.image = r, void e._finishLoading())
                    })
                    ...
                    this.map = t, this.image && this.setCoordinates(this.coordinates)
                    ...
                    return o.column = Math.round(o.column), o.row = Math.round(o.row), this.minzoom = this.maxzoom = o.zoom, this.coord = new TileCoord(o.zoom, o.column, o.row), this._tileCoords = r.map(function (t) {
                        var e = t.zoomTo(o.zoom);
                        return new Point(Math.round((e.column - o.column) * EXTENT), Math.round((e.row - o.row) * EXTENT))
                    }), this.fire("data", {dataType: "source"}), this
                }, e.prototype._setTile = function (t) {
                    this.tile = t;
                    var e = 32767, r = new RasterBoundsArray;
                ...
                }, e.prototype._prepareImage = function (t, e) {
                    "loaded" !== this.tile.state ? (this.tile.state = "loaded", this.tile.texture = t.createTexture(), t.bindTexture(t.TEXTURE_2D, this.tile.texture), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_WRAP_S, t.CLAMP_TO_EDGE), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_WRAP_T, t.CLAMP_TO_EDGE), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_MIN_FILTER, t.LINEAR), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_MAG_FILTER, t.LINEAR), t.texImage2D(t.TEXTURE_2D, 0, t.RGBA, t.RGBA, t.UNSIGNED_BYTE, e)) : e instanceof window.HTMLVideoElement && (t.bindTexture(t.TEXTURE_2D, this.tile.texture), t.texSubImage2D(t.TEXTURE_2D, 0, 0, 0, t.RGBA, t.UNSIGNED_BYTE, e))
                }, e.prototype.loadTile = function (t, e) {
        ...
        44: [function (require, module, exports) {
            "use strict";
            var util = require("../util/util"), ajax = require("../util/ajax"), browser = require("../util/browser"), normalizeURL = require("../util/mapbox").normalizeSourceURL;
        ...
        }, {"../util/ajax": 107, "../util/browser": 108, "../util/mapbox": 123, "../util/util": 127}],
        ...
        46: [function (require, module, exports) {
            ...
            exports.rendered = function (e, r, o, t, n, a) {
                ...
                for (var o = e.getRenderableIds().map(function (r) {
                    ...
                    var i = o[a], u = new TileCoord(Math.min(i.sourceMaxZoom, i.coord.z), i.coord.x, i.coord.y, 0).id;
        ...
        47: [function (require, module, exports) {
            "use strict";
            var util = require("../util/util"), ajax = require("../util/ajax"), Evented = require("../util/evented"), loadTileJSON = require("./load_tilejson"), normalizeURL = require("../util/mapbox").normalizeTileURL, RasterTileSource = function (e) {
                function t(t, i, r, a) {
                    var o = this;
                    e.call(this), this.id = t, this.dispatcher = r, this.minzoom = 0, this.maxzoom = 22, this.roundZoom = !0, this.scheme = "xyz", this.tileSize = 512, this._loaded = !1, util.extend(this, util.pick(i, ["url", "scheme", "tileSize"])), this.setEventedParent(a), this.fire("dataloading", {dataType: "source"}), loadTileJSON(i, function (e, t) {
                        return e ? o.fire("error", e) : (util.extend(o, t), o.fire("data", {dataType: "source"}), void o.fire("source.load"))
                    })
                }
        ...
        48: [function (require, module, exports) {
            ...
            "../source/geojson_source": 40,
            "../source/image_source": 43,
            "../source/raster_tile_source": 47,
            "../source/vector_tile_source": 52,
            "../source/video_source": 54,
            "../util/util": 127
        }],
        49: [function (require, module, exports) {
            "use strict";
            function coordinateToTilePoint(e, o, t) {
                var r = t.zoomTo(Math.min(e.z, o));
                return {x: (r.column - (e.x + e.w * Math.pow(2, e.z))) * EXTENT, y: (r.row - e.y) * EXTENT}
            }

            function compareKeyZoom(e, o) {
                return e % 32 - o % 32
            }

            var Source = require("./source"), Tile = require("./tile"), Evented = require("../util/evented"), TileCoord = require("./tile_coord"), Cache = require("../util/lru_cache"), Coordinate = require("../geo/coordinate"), util = require("../util/util"), EXTENT = require("../data/extent"), SourceCache = function (e) {
                function o(o, t, r) {
                    e.call(this), this.id = o, this.dispatcher = r, this._source = Source.create(o, t, r, this), this.on("source.load", function () {
                        this.map && this._source.onAdd && this._source.onAdd(this.map), this._sourceLoaded = !0
                    }), this.on("error", function () {
                        this._sourceErrored = !0
                    }), this.on("data", function (e) {
                        this._sourceLoaded && "source" === e.dataType && (this.reload(), this.transform && this.update(this.transform))
                    }), this._tiles = {}, this._cache = new Cache(0, this.unloadTile.bind(this)), this._isIdRenderable = this._isIdRenderable.bind(this)
                }
                ...
                return e && (o.__proto__ = e), o.prototype = Object.create(e && e.prototype), o.prototype.constructor = o, o.prototype.onAdd = function (e) {
                    ...
                    return this._source
                }, o.prototype.loadTile = function (e, o) {
                    return this._source.loadTile(e, o)
                }, o.prototype.unloadTile = function (e) {
                    if (this._source.unloadTile)return this._source.unloadTile(e)
                }, o.prototype.abortTile = function (e) {
                ...
                }, o.prototype.getRenderableIds = function () {
                    return this.getIds().filter(this._isIdRenderable)
                }, o.prototype._isIdRenderable = function (e) {
                    ...
                    for (var o in this._tiles) {
                        var t = e._tiles[o];
                        "loading" !== t.state && (t.state = "reloading"), e.loadTile(e._tiles[o], e._tileLoaded.bind(e, e._tiles[o]))
                    }
                }, o.prototype._tileLoaded = function (e, o) {
                    return o ? (e.state = "errored", void this._source.fire("error", {
                        tile: e,
                        error: o
                    })) : (e.sourceCache = this, e.timeAdded = (new Date).getTime(), this._source.fire("data", {
                        tile: e,
                        coord: e.coord,
                        dataType: "tile"
                    }), void(this.map && (this.map.painter.tileExtentVAO.vao = null)))
                }, o.prototype.getTile = function (e) {
                    return this.getTileByID(e.id)
                }, o.prototype.getTileByID = function (e) {
                    return this._tiles[e]
                }, o.prototype.getZoom = function (e) {
                    return e.zoom + e.scaleZoom(e.tileSize / this._source.tileSize)
                }, o.prototype.findLoadedChildren = function (e, o, t) {
                    var r = this, i = !1;
                    for (var s in this._tiles) {
                        var a = r._tiles[s];
                        if (!(t[s] || !a.hasData() || a.coord.z <= e.z || a.coord.z > o)) {
                            var n = Math.pow(2, Math.min(a.coord.z, r._source.maxzoom) - Math.min(e.z, r._source.maxzoom));
                            if (Math.floor(a.coord.x / n) === e.x && Math.floor(a.coord.y / n) === e.y)for (t[s] = !0, i = !0; a && a.coord.z - 1 > e.z;) {
                                var d = a.coord.parent(r._source.maxzoom).id;
                                a = r._tiles[d], a && a.hasData() && (delete t[s], t[d] = !0)
                            }
                        }
                    }
                    return i
                }, o.prototype.findLoadedParent = function (e, o, t) {
                    for (var r = this, i = e.z - 1; i >= o; i--) {
                        e = e.parent(r._source.maxzoom);
                        var s = r._tiles[e.id];
                        if (s && s.hasData())return t[e.id] = !0, s;
                        if (r._cache.has(e.id))return r.addTile(e), t[e.id] = !0, r._tiles[e.id]
                    }
                }, o.prototype.updateCacheSize = function (e) {
                    var o = Math.ceil(e.width / e.tileSize) + 1, t = Math.ceil(e.height / e.tileSize) + 1, r = o * t, i = 5;
                    this._cache.setMaxSize(Math.floor(r * i))
                }, o.prototype.update = function (e) {
                    var t = this;
                    if (this._sourceLoaded) {
                        var r, i, s;
                        this.updateCacheSize(e);
                        var a = (this._source.roundZoom ? Math.round : Math.floor)(this.getZoom(e)), n = Math.max(a - o.maxOverzooming, this._source.minzoom), d = Math.max(a + o.maxUnderzooming, this._source.minzoom), c = {};
                        this._coveredTiles = {};
                        var h;
                        for (h = this.used ? this._source.coord ? [this._source.coord] : e.coveringTiles({
                            tileSize: this._source.tileSize,
                            minzoom: this._source.minzoom,
                            maxzoom: this._source.maxzoom,
                            roundZoom: this._source.roundZoom,
                            reparseOverscaled: this._source.reparseOverscaled
                        }) : [], r = 0; r < h.length; r++)i = h[r], s = t.addTile(i), c[i.id] = !0, s.hasData() || t.findLoadedChildren(i, d, c) || t.findLoadedParent(i, n, c);
                        for (var u = {}, l = Object.keys(c), p = 0; p < l.length; p++) {
                            var _ = l[p];
                            i = TileCoord.fromID(_), s = t._tiles[_], s && s.fadeEndTime >= Date.now() && (t.findLoadedChildren(i, d, c) && (c[_] = !0), t.findLoadedParent(i, n, u))
                        }
                        var m;
                        for (m in u)c[m] || (t._coveredTiles[m] = !0);
                        for (m in u)c[m] = !0;
                        var f = util.keysDifference(this._tiles, c);
                        for (r = 0; r < f.length; r++)t.removeTile(+f[r]);
                        this.transform = e
                    }
                }, o.prototype.addTile = function (e) {
                    var o = this._tiles[e.id];
                    if (o)return o;
                    var t = e.wrapped();
                    if (o = this._tiles[t.id], o || (o = this._cache.get(t.id), o && o.redoPlacement(this._source)), !o) {
                        var r = e.z, i = r > this._source.maxzoom ? Math.pow(2, r - this._source.maxzoom) : 1;
                        o = new Tile(t, this._source.tileSize * i, this._source.maxzoom), this.loadTile(o, this._tileLoaded.bind(this, o))
                    }
                    return o.uses++, this._tiles[e.id] = o, this._source.fire("dataloading", {
                        tile: o,
                        coord: o.coord,
                        dataType: "tile"
                    }), o
                }, o.prototype.removeTile = function (e) {
                    var o = this._tiles[e];
                    o && (o.uses--, delete this._tiles[e], this._source.fire("data", {
                        tile: o,
                        coord: o.coord,
                        dataType: "tile"
                    }), o.uses > 0 || (o.hasData() ? this._cache.add(o.coord.wrapped().id, o) : (o.aborted = !0, this.abortTile(o), this.unloadTile(o))))
                }, o.prototype.clearTiles = function () {
                    var e = this;
                    for (var o in this._tiles)e.removeTile(o);
                    this._cache.reset()
                }, o.prototype.tilesIn = function (e) {
                    for (var o = this, t = {}, r = this.getIds(), i = 1 / 0, s = 1 / 0, a = -(1 / 0), n = -(1 / 0), d = e[0].zoom, c = 0; c < e.length; c++) {
                        var h = e[c];
                        i = Math.min(i, h.column), s = Math.min(s, h.row), a = Math.max(a, h.column), n = Math.max(n, h.row)
                    }
                    for (var u = 0; u < r.length; u++) {
                        var l = o._tiles[r[u]], p = TileCoord.fromID(r[u]), _ = [coordinateToTilePoint(p, l.sourceMaxZoom, new Coordinate(i, s, d)), coordinateToTilePoint(p, l.sourceMaxZoom, new Coordinate(a, n, d))];
                        if (_[0].x < EXTENT && _[0].y < EXTENT && _[1].x >= 0 && _[1].y >= 0) {
                            for (var m = [], f = 0; f < e.length; f++)m.push(coordinateToTilePoint(p, l.sourceMaxZoom, e[f]));
                            var v = t[l.coord.id];
                            void 0 === v && (v = t[l.coord.id] = {
                                tile: l,
                                coord: p,
                                queryGeometry: [],
                                scale: Math.pow(2, o.transform.zoom - l.coord.z)
                            }), v.queryGeometry.push(m)
                        }
                    }
                    var T = [];
                    for (var y in t)T.push(t[y]);
                    return T
                }, o.prototype.redoPlacement = function () {
                    for (var e = this, o = this.getIds(), t = 0; t < o.length; t++) {
                        var r = e.getTileByID(o[t]);
                        r.redoPlacement(e._source)
                    }
                }, o.prototype.getVisibleCoordinates = function () {
                    for (var e = this, o = this.getRenderableIds().map(TileCoord.fromID), t = 0, r = o; t < r.length; t += 1) {
                        var i = r[t];
                        i.posMatrix = e.transform.calculatePosMatrix(i, e._source.maxzoom)
                    }
                    return o
                }, o
            }(Evented);
        ...
        50: [function (require, module, exports) {
            ...
            Tile.prototype.registerFadeDuration = function (e, t) {
                ...
                if ("unloaded" !== this.state) {
                    ...
                    for (var o in this.buckets) {
                        var s = i.buckets[o];
                        "symbol" === s.type && (s.destroy(), delete i.buckets[o])
                    }
                ...
                function t(t, i) {
                    this.reloadSymbolData(i, e.map.style), e.fire("data", {
                        tile: this,
                        coord: this.coord,
                        dataType: "tile"
                    }), e.map && (e.map.painter.tileExtentVAO.vao = null), this.state = "loaded", this.redoWhenDone && (this.redoPlacement(e), this.redoWhenDone = !1)
                }

                if ("vector" === e.type || "geojson" === e.type) {
                    if ("loaded" !== this.state || "reloading" === this.state)return void(this.redoWhenDone = !0);
                    this.state = "reloading", e.dispatcher.send("redoPlacement", {
                        type: e.type,
                        uid: this.uid,
                        source: e.id,
                ...
                if (this.rawTileData) {
                    ...
                    if (o)for (var s = featureFilter(t && t.filter), r = {
                        z: this.coord.z,
                        x: this.coord.x,
                        y: this.coord.y
                    }, a = 0; a < o.length; a++) {
            ...
            "../symbol/collision_box": 76,
            "../symbol/collision_tile": 78,
            "../symbol/symbol_instances": 87,
            "../symbol/symbol_quads": 88,
            "../util/util": 127,
            "../util/vectortile_to_geojson": 128,
            "feature-filter": 135,
            "pbf": 193,
        ...
        51: [function (require, module, exports) {
            ...
            var WhooTS = require("whoots-js"), Coordinate = require("../geo/coordinate"), TileCoord = function (t, i, o, r) {
            ...
            TileCoord.prototype.toString = function () {
                ...
                var i = Math.min(this.z, void 0 === t ? this.z : t), o = Math.pow(2, i), r = this.y, e = this.x + o * this.w;
                ...
                function r(t, i, r) {
                    var h, s, a;
                    if (r >= 0 && r <= e)for (h = t; h < i; h++)s = (h % e + e) % e, a = new TileCoord(o, s, r, Math.floor(h / e)), n[a.id] = a
                }
        ...
        }, {"../geo/coordinate": 18, "whoots-js": 213}],
        52: [function (require, module, exports) {
            "use strict";
            var Evented = require("../util/evented"), util = require("../util/util"), loadTileJSON = require("./load_tilejson"), normalizeURL = require("../util/mapbox").normalizeTileURL, VectorTileSource = function (e) {
                function t(t, i, o, r) {
                    var l = this;
                    ...
                    this.setEventedParent(r), this.fire("dataloading", {dataType: "source"}), loadTileJSON(i, function (e, t) {
                        return e ? void l.fire("error", e) : (util.extend(l, t), l.fire("data", {dataType: "source"}), void l.fire("source.load"))
                    })
                }
                ...
                return e && (t.__proto__ = e), t.prototype = Object.create(e && e.prototype), t.prototype.constructor = t, t.prototype.onAdd = function (e) {
                    ...
                    function i(i, o) {
                        if (!e.aborted) {
                            if (i)return t(i);
                            e.loadVectorData(o, this.map.painter), e.redoWhenDone && (e.redoWhenDone = !1, e.redoPlacement(this)), t(null), e.reloadCallback && (this.loadTile(e, e.reloadCallback), e.reloadCallback = null)
                        }
                    }
                    ...
                    e.workerID ? "loading" === e.state ? e.reloadCallback = t : this.dispatcher.send("reloadTile", r, i.bind(this), e.workerID) : e.workerID = this.dispatcher.send("loadTile", r, i.bind(this))
                }, t.prototype.abortTile = function (e) {
        ...
        }, {"../util/evented": 116, "../util/mapbox": 123, "../util/util": 127, "./load_tilejson": 44}],
        53: [function (require, module, exports) {
            "use strict";
            var ajax = require("../util/ajax"), vt = require("vector-tile"), Protobuf = require("pbf"), WorkerTile = require("./worker_tile"), util = require("../util/util"), VectorTileWorkerSource = function (e, r, t) {
            ...
            VectorTileWorkerSource.prototype.loadTile = function (e, r) {
                function t(e, t) {
                    return delete this.loading[o][i], e ? r(e) : t ? (a.vectorTile = t, a.parse(t, this.layerIndex, this.actor, function (e, o, i) {
                        return e ? r(e) : void r(null, util.extend({rawTileData: t.rawData}, o), i)
                ...
                function t(e, t) {
                    if (e)return r(e);
                    var o = new vt.VectorTile(new Protobuf(t));
                    o.rawData = t, r(e, o)
                }
        ...
        }, {"../util/ajax": 107, "../util/util": 127, "./worker_tile": 56, "pbf": 193, "vector-tile": 204}],
        54: [function (require, module, exports) {
            "use strict";
            var ajax = require("../util/ajax"), ImageSource = require("./image_source"), VideoSource = function (e) {
                function t(t, o, i, r) {
                    e.call(this, t, o, i, r), this.roundZoom = !0
                }

                return e && (t.__proto__ = e), t.prototype = Object.create(e && e.prototype), t.prototype.constructor = t, t.prototype._load = function (e) {
                    var t = this;
                    ...
                    this.map || (this.map = e, this.video && (this.video.play(), this.setCoordinates(this.coordinates)))
        ...
        }, {"../util/ajax": 107, "./image_source": 43}],
        55: [function (require, module, exports) {
            "use strict";
            var Actor = require("../util/actor"), StyleLayerIndex = require("../style/style_layer_index"), VectorTileWorkerSource = require("./vector_tile_worker_source"), GeoJSONWorkerSource = require("./geojson_worker_source"), Worker = function (e) {
                var r = this;
            ...
            Worker.prototype.setLayers = function (e, r) {
                ...
                if (this.workerSources[e] || (this.workerSources[e] = {}), !this.workerSources[e][r]) {
                    var t = {
                        send: function (r, t, i, s) {
                            o.actor.send(r, t, i, s, e)
                        }
                    };
            ...
            "../style/style_layer_index": 69,
            "../util/actor": 106,
            "./geojson_worker_source": 41,
            "./vector_tile_worker_source": 53
        }],
        56: [function (require, module, exports) {
            ...
            var FeatureIndex = require("../data/feature_index"), CollisionTile = require("../symbol/collision_tile"), CollisionBoxArray = require("../symbol/collision_box"), DictionaryCoder = require("../util/dictionary_coder"), util = require("../util/util"), SymbolInstancesArray = require("../symbol/symbol_instances"), SymbolQuadsArray = require("../symbol/symbol_quads"), WorkerTile = function (e) {
            ...
            WorkerTile.prototype.parse = function (e, r, i, s) {
                var o = this;
                e.layers || (e = {layers: {_geojsonTileLayer: e}}), this.status = "parsing", this.data = e, this.collisionBoxArray = new CollisionBoxArray, this.symbolInstancesArray = new SymbolInstancesArray, this.symbolQuadsArray = new SymbolQuadsArray;
                var l = new DictionaryCoder(Object.keys(e.layers).sort()), t = new FeatureIndex(this.coord, this.overscaling);
                t.bucketLayerIDs = {};
                var a = {}, n = 0, c = {
                    featureIndex: t,
                    iconDependencies: {},
                ...
                var T = 0, q = Object.keys(c.iconDependencies), D = util.mapObject(c.glyphDependencies, function (e) {
                ...
                Object.keys(D).length ? i.send("getGlyphs", {uid: this.uid, stacks: D}, function (e, r) {
                    D = r, O(e)
                }) : O(), q.length ? i.send("getIcons", {icons: q}, function (e, r) {
                    q = r, O(e)
                }) : O()
                ...
                var n = [];
                return {
                    result: {buckets: serializeBuckets(this.symbolBuckets, n), collisionTile: o.serialize(n)},
                    transferables: n
                }
        ...
        58: [function (require, module, exports) {
            "use strict";
            var Evented = require("../util/evented"), ajax = require("../util/ajax"), browser = require("../util/browser"), normalizeURL = require("../util/mapbox").normalizeSpriteURL, SpritePosition = function () {
                this.x = 0, this.y = 0, this.width = 0, this.height = 0, this.pixelRatio = 1, this.sdf = !1
            }, ImageSprite = function (t) {
                function i(i) {
                    var e = this;
                    t.call(this), this.base = i, this.retina = browser.devicePixelRatio > 1;
                    var a = this.retina ? "@2x" : "";
                    ajax.getJSON(normalizeURL(i, a, ".json"), function (t, i) {
                        return t ? void e.fire("error", {error: t}) : (e.data = i, void(e.imgData && e.fire("data", {dataType: "style"})))
                    }), ajax.getImage(normalizeURL(i, a, ".png"), function (t, i) {
                        if (t)return void e.fire("error", {error: t});
                        e.imgData = browser.getImageData(i);
                        for (var a = 0; a < e.imgData.length; a += 4) {
                            var r = e.imgData[a + 3] / 255;
                            e.imgData[a + 0] *= r, e.imgData[a + 1] *= r, e.imgData[a + 2] *= r
                        }
                        e.width = i.width, e.data && e.fire("data", {dataType: "style"})
                    })
                }
        ...
        }, {"../util/ajax": 107, "../util/browser": 108, "../util/evented": 116, "../util/mapbox": 123}],
        59: [function (require, module, exports) {
            "use strict";
            var styleSpec = require("./style_spec"), util = require("../util/util"), Evented = require("../util/evented"), validateStyle = require("./validate_style"), StyleDeclaration = require("./style_declaration"), StyleTransition = require("./style_transition"), TRANSITION_SUFFIX = "-transition", Light = function (t) {
                function i(i) {
                ...
                return t && (i.__proto__ = t), i.prototype = Object.create(t && t.prototype), i.prototype.constructor = i, i.prototype.set = function (t) {
                    ...
                    var i = this;
                    for (var e in this._declarations)i.calculated[e] = i.getLightValue(e, {zoom: t})
                    ...
                    if (null !== i && void 0 !== i || (i = new StyleDeclaration(a, a.default)), !r || r.declaration.json !== i.json) {
                        var s = util.extend({
                            duration: 300,
                            delay: 0
                        }, o, this.getLightProperty(t + TRANSITION_SUFFIX)), l = this._transitions[t] = new StyleTransition(a, i, r, s);
        ...
        60: [function (require, module, exports) {
            "use strict";
            var parseColorString = require("csscolorparser").parseCSSColor, util = require("../util/util"), MapboxGLFunction = require("mapbox-gl-function"), cache = {};
        ...
        }, {"../util/util": 127, "csscolorparser": 132, "mapbox-gl-function": 160}],
        61: [function (require, module, exports) {
            "use strict";
            var Evented = require("../util/evented"), StyleLayer = require("./style_layer"), ImageSprite = require("./image_sprite"), Light = require("./light"), GlyphSource = require("../symbol/glyph_source"), SpriteAtlas = require("../symbol/sprite_atlas"), LineAtlas = require("../render/line_atlas"), util = require("../util/util"), ajax = require("../util/ajax"), mapbox = require("../util/mapbox"), browser = require("../util/browser"), Dispatcher = require("../util/dispatcher"), AnimationLoop = require("./animation_loop"), validateStyle = require("./validate_style"), Source = require("../source/source"), QueryFeatures = require("../source/query_features"), SourceCache = require("../source/source_cache"), styleSpec = require("./style_spec"), MapboxGLFunction = require("mapbox-gl-function"), getWorkerPool = require("../global_worker_pool"), deref = require("mapbox-gl-style-spec/lib/deref"), diff = require("mapbox-gl-style-spec/lib/diff"), supportedDiffOperations = util.pick(diff.operations, ["addLayer", "removeLayer", "setPaintProperty", "setLayoutProperty", "setFilter", "addSource", "removeSource", "setLayerZoomRange", "setLight", "setTransition"]), ignoredDiffOperations = util.pick(diff.operations, ["setCenter", "setZoom", "setBearing", "setPitch"]), Style = function (e) {
                function t(t, r, i) {
                    var s = this;
                    e.call(this), this.map = r, this.animationLoop = r && r.animationLoop || new AnimationLoop, this.dispatcher = new Dispatcher(getWorkerPool(), this), this.spriteAtlas = new SpriteAtlas(1024, 1024), this.lineAtlas = new LineAtlas(256, 512), this._layers = {}, this._order = [], this.sourceCaches = {}, this.zoomHistory = {}, this._loaded = !1, util.bindAll(["_redoPlacement"], this), this._resetUpdates(), i = util.extend({validate: "string" != typeof t || !mapbox.isMapboxURL(t)}, i), this.setEventedParent(r), this.fire("dataloading", {dataType: "style"});
                    var o = function (e, t) {
                        if (e)return void s.fire("error", {error: e});
                        if (!i.validate || !validateStyle.emitErrors(s, validateStyle(t))) {
                            s._loaded = !0, s.stylesheet = t, s.updateClasses();
                            for (var r in t.sources)s.addSource(r, t.sources[r], i);
                            t.sprite && (s.sprite = new ImageSprite(t.sprite), s.sprite.setEventedParent(s)), s.glyphSource = new GlyphSource(t.glyphs), s._resolve(), s.fire("data", {dataType: "style"}), s.fire("style.load")
                        }
                    };
                    "string" == typeof t ? ajax.getJSON(mapbox.normalizeStyleURL(t), o) : browser.frame(o.bind(this, null, t)), this.on("source.load", function (e) {
                        var t = s.sourceCaches[e.sourceId].getSource();
                        if (t && t.vectorLayerIds)for (var r in s._layers) {
                            var i = s._layers[r];
                            i.source === t.id && s._validateLayer(i)
                        }
                    })
                }
                ...
                return e && (t.__proto__ = e), t.prototype = Object.create(e && e.prototype), t.prototype.constructor = t, t.prototype._validateLayer = function (e) {
                    ...
                    if (e.sourceLayer && t) {
                        var r = t.getSource();
                        r.vectorLayerIds && r.vectorLayerIds.indexOf(e.sourceLayer) === -1 && this.fire("error", {error: new Error('Source layer "' + e.sourceLayer + '" does not exist on source "' + r.id + '" as specified by style layer "' + e.id + '"')})
                    }
                }, t.prototype.loaded = function () {
                    var e = this;
                    if (!this._loaded)return !1;
                    if (Object.keys(this._updatedSources).length)return !1;
                    for (var t in this.sourceCaches)if (!e.sourceCaches[t].loaded())return !1;
                    ...
                    for (var r = 0, i = t; r < i.length; r += 1) {
                        var s = i[r];
                        s = StyleLayer.create(s), s.setEventedParent(e, {layer: {id: s.id}}), e._layers[s.id] = s
                    }
                    ...
                    if (this._loaded) {
                        ...
                        var i = this.stylesheet.transition || {}, s = this._updatedAllPaintProps ? this._layers : this._updatedPaintProps;
                        for (var o in s) {
                            var a = r._layers[o], n = r._updatedPaintProps[o];
                            if (r._updatedAllPaintProps || n.all) a.updatePaintTransitions(e, t, i, r.animationLoop, r.zoomHistory); else for (var l in n)r._layers[o].updatePaintTransition(l, e, t, i, r.animationLoop, r.zoomHistory)
                        }
                    ...
                    if (this._loaded) {
                        ...
                        for (var i = 0, s = this._order; i < s.length; i += 1) {
                            var o = s[i], a = t._layers[o];
                    ...
                    var r = this;
                    if (this._changed) {
                        var i = Object.keys(this._updatedLayers), s = Object.keys(this._removedLayers);
                        (i.length || s.length || this._updatedSymbolOrder) && this._updateWorkerLayers(i, s);
                        for (var o in this._updatedSources) {
                    ...
                    var i = ["vector", "raster", "geojson", "video", "image"], s = i.indexOf(t.type) >= 0;
                    if (!s || !this._validate(validateStyle.source, "sources." + e, t, null, r)) {
                        var o = this.sourceCaches[e] = new SourceCache(e, t, this.dispatcher);
                        o.style = this, o.setEventedParent(this, function () {
                            return {isSourceLoaded: o.loaded(), source: o.serialize(), sourceId: e}
                    ...
                    this._checkLoaded();
                    var i = e.id;
                    if (!this._validate(validateStyle.layer, "layers." + i, e, {arrayIndex: -1}, r)) {
                        var s = StyleLayer.create(e);
                        this._validateLayer(s), s.setEventedParent(this, {layer: {id: i}});
                        var o = t ? this._order.indexOf(t) : this._order.length;
                        this._order.splice(o, 0, i), this._layers[i] = s, this._removedLayers[i] && (delete this._removedLayers[i], this._updatedSources[s.source] = "clear"), this._updateLayer(s), "symbol" === s.type && (this._updatedSymbolOrder = !0), this.updateClasses(i)
                    }
                }, t.prototype.moveLayer = function (e, t) {
                    this._checkLoaded(), this._changed = !0;
                    var r = this._layers[e];
                    if (!r)throw new Error("Layer not found: " + e);
                    var i = this._order.indexOf(e);
                    this._order.splice(i, 1);
                    var s = t ? this._order.indexOf(t) : this._order.length;
                    this._order.splice(s, 0, e), "symbol" === r.type && (this._updatedSymbolOrder = !0, r.source && !this._updatedSources[r.source] && (this._updatedSources[r.source] = "reload"))
                }, t.prototype.removeLayer = function (e) {
                    this._checkLoaded();
                    var t = this._layers[e];
                    if (!t)throw new Error("Layer not found: " + e);
                    t.setEventedParent(null);
                    var r = this._order.indexOf(e);
                    this._order.splice(r, 1), "symbol" === t.type && (this._updatedSymbolOrder = !0), this._changed = !0, this._removedLayers[e] = !0, delete this._layers[e], delete this._updatedLayers[e], delete this._updatedPaintProps[e]
                    ...
                    if (!util.deepEqual(s.getPaintProperty(t, i), r)) {
                        var o = s.isPaintValueFeatureConstant(t);
                        s.setPaintProperty(t, r, i);
                        var a = !(r && MapboxGLFunction.isFunctionDefinition(r) && "$zoom" !== r.property && void 0 !== r.property);
                        a && o || this._updateLayer(s), this.updateClasses(e, t)
                    }
                    ...
                    for (var t = this, r = [], i = this._order.length - 1; i >= 0; i--)for (var s = t._order[i], o = 0, a = e; o < a.length; o += 1) {
                        var n = a[o], l = n[s];
                        if (l)for (var h = 0, u = l; h < u.length; h += 1) {
                            var d = u[h];
                            r.push(d)
                        }
                    }
                    ...
                    var o = {};
                    if (t && t.layers)for (var a = 0, n = t.layers; a < n.length; a += 1) {
                        var l = n[a], h = s._layers[l];
                        if (!h)return void s.fire("error", {error: "The layer '" + l + "' does not exist in the map's style and cannot be queried for features."});
                        o[h.source] = !0
                    }
                    var u = [];
                    for (var d in this.sourceCaches)if (!t.layers || o[d]) {
                        var c = QueryFeatures.rendered(s.sourceCaches[d], s._layers, e, t, r, i);
                        u.push(c)
                    }
                    ...
                    for (var s in e)if (!util.deepEqual(e[s], r[s])) {
                        i = !0;
                        break
                    }
                    if (i) {
                ...
                }, t.prototype._validate = function (e, t, r, i, s) {
                    return (!s || s.validate !== !1) && validateStyle.emitErrors(this, e.call(validateStyle, util.extend({
                            key: t,
                    ...
                    this.sprite.loaded() ? s() : this.sprite.on("data", s)
                }, t.prototype.getGlyphs = function (e, t, r) {
                    function i(e, t, i) {
                        e && console.error(e), n[i] = t, a--, 0 === a && r(null, n)
                    }

                    var s = this, o = t.stacks, a = Object.keys(o).length, n = {};
                    for (var l in o)s.glyphSource.getSimpleGlyphs(l, o[l], t.uid, i)
                }, t
            }(Evented);
            ...
            "../source/query_features": 46,
            "../source/source": 48,
            "../source/source_cache": 49,
            "../symbol/glyph_source": 81,
            "../symbol/sprite_atlas": 86,
            "../util/ajax": 107,
            "../util/browser": 108,
            "../util/dispatcher": 114,
            "../util/evented": 116,
            ...
            "./style_spec": 70,
            "./validate_style": 72,
            "mapbox-gl-function": 160,
            "mapbox-gl-style-spec/lib/deref": 161,
            "mapbox-gl-style-spec/lib/diff": 162
        }],
        62: [function (require, module, exports) {
            "use strict";
            var MapboxGLFunction = require("mapbox-gl-function"), parseColor = require("./parse_color"), util = require("../util/util"), StyleDeclaration = function (t, o) {
                var i = this;
                ...
                var n = this.isColor && this.value ? parseColor(this.value) : o, s = t.default;
        ...
        }, {"../util/util": 127, "./parse_color": 60, "mapbox-gl-function": 160}],
        63: [function (require, module, exports) {
            ...
            var util = require("../util/util"), StyleTransition = require("./style_transition"), StyleDeclaration = require("./style_declaration"), styleSpec = require("./style_spec"), validateStyle = require("./validate_style"), parseColor = require("./parse_color"), Evented = require("../util/evented"), TRANSITION_SUFFIX = "-transition", StyleLayer = function (t) {
                function i(i) {
                    var a = this;
                ...
                return t && (i.__proto__ = t), i.prototype = Object.create(t && t.prototype), i.prototype.constructor = i, i.prototype.setLayoutProperty = function (t, i, a) {
                    ...
                    var i = this;
                    for (var a in this._paintTransitions)i.paint[a] = i.getPaintValue(a, {zoom: t});
                    for (var e in this._layoutFunctions)i.layout[e] = i.getLayoutValue(e, {zoom: t})
                    ...
                    if (null !== i && void 0 !== i || (i = new StyleDeclaration(s, s.default)), !r || r.declaration.json !== i.json) {
                        var l = util.extend({
                            duration: 300,
                            delay: 0
                        }, e, this.getPaintProperty(t + TRANSITION_SUFFIX)), u = this._paintTransitions[t] = new StyleTransition(s, i, r, l, o);
            ...
            "./parse_color": 60,
            "./style_declaration": 62,
            "./style_layer/circle_style_layer": 64,
            "./style_layer/fill_extrusion_style_layer": 65,
            "./style_layer/fill_style_layer": 66,
            "./style_layer/line_style_layer": 67,
            "./style_layer/symbol_style_layer": 68,
            "./style_spec": 70,
            "./style_transition": 71,
            "./validate_style": 72
        }],
        64: [function (require, module, exports) {
            "use strict";
            var StyleLayer = require("../style_layer"), CircleBucket = require("../../data/bucket/circle_bucket"), CircleStyleLayer = function (e) {
                function t() {
        ...
        }, {"../../data/bucket/circle_bucket": 3, "../style_layer": 63}],
        65: [function (require, module, exports) {
            "use strict";
            var StyleLayer = require("../style_layer"), FillExtrusionBucket = require("../../data/bucket/fill_extrusion_bucket"), FillExtrusionStyleLayer = function (t) {
                function e() {
        ...
        }, {"../../data/bucket/fill_extrusion_bucket": 5, "../style_layer": 63}],
        66: [function (require, module, exports) {
            "use strict";
            var StyleLayer = require("../style_layer"), FillBucket = require("../../data/bucket/fill_bucket"), FillStyleLayer = function (t) {
                function o() {
                    t.apply(this, arguments)
                }
                ...
                return t && (o.__proto__ = t), o.prototype = Object.create(t && t.prototype), o.prototype.constructor = o, o.prototype.getPaintValue = function (o, l, e) {
                    return "fill-outline-color" === o && void 0 === this.getPaintProperty("fill-outline-color") ? t.prototype.getPaintValue.call(this, "fill-color", l, e) : t.prototype.getPaintValue.call(this, o, l, e)
        ...
        }, {"../../data/bucket/fill_bucket": 4, "../style_layer": 63}],
        67: [function (require, module, exports) {
            "use strict";
            var StyleLayer = require("../style_layer"), LineBucket = require("../../data/bucket/line_bucket"), util = require("../../util/util"), LineStyleLayer = function (e) {
                function t() {
                    e.apply(this, arguments)
                }
        ...
        }, {"../../data/bucket/line_bucket": 6, "../../util/util": 127, "../style_layer": 63}],
        68: [function (require, module, exports) {
            "use strict";
            var StyleLayer = require("../style_layer"), SymbolBucket = require("../../data/bucket/symbol_bucket"), SymbolStyleLayer = function (t) {
                function e() {
                    t.apply(this, arguments)
                }
        ...
        }, {"../../data/bucket/symbol_bucket": 7, "../style_layer": 63}],
        69: [function (require, module, exports) {
            "use strict";
            var StyleLayer = require("./style_layer"), util = require("../util/util"), featureFilter = require("feature-filter"), groupByLayout = require("mapbox-gl-style-spec/lib/group_by_layout"), StyleLayerIndex = function (e) {
                e && this.replace(e)
            };
            StyleLayerIndex.prototype.replace = function (e) {
                ...
                for (var t = 0, a = e; t < a.length; t += 1) {
                    var i = a[t];
                    "symbol" === i.type && r.symbolOrder.push(i.id)
                }
                this._layers = {}, this.update(e, [])
            }, StyleLayerIndex.prototype.update = function (e, r, t) {
                for (var a = this, i = 0, l = e; i < l.length; i += 1) {
                    var y = l[i];
                    a._layers[y.id] = y
                }
                ...
                for (var n = groupByLayout(util.values(this._layers)), p = 0, f = n; p < f.length; p += 1) {
                    var h = f[p];
                    h = h.map(function (e) {
                        return e = StyleLayer.create(e), e.updatePaintTransitions({}, {transition: !1}), e.filter = featureFilter(e.filter), e
                    });
                    var v = h[0];
                    if (!v.layout || "none" !== v.layout.visibility) {
                        var c = v.source || "", d = a.familiesBySource[c];
                        d || (d = a.familiesBySource[c] = {});
                        var m = v.sourceLayer || "_geojsonTileLayer", L = d[m];
                        L || (L = d[m] = []), L.push(h)
                    }
                }
            ...
            "./style_layer": 63,
            "feature-filter": 135,
            "mapbox-gl-style-spec/lib/group_by_layout": 164
        }],
        70: [function (require, module, exports) {
            "use strict";
            module.exports = require("mapbox-gl-style-spec/reference/latest.min");
        }, {"mapbox-gl-style-spec/reference/latest.min": 188}],
        71: [function (require, module, exports) {
            ...
            var util = require("../util/util"), interpolate = require("../util/interpolate"), fakeZoomHistory = {
                lastIntegerZoom: 0,
            ...
            StyleTransition.prototype.instant = function () {
                ...
                var a = this.oldTransition.calculate(t, i, this.startTime), n = util.easeCubicInOut((o - this.startTime - this.delay) / this.duration);
                ...
                var o = t.zoom, e = this.zoomHistory.lastIntegerZoom, a = o > e ? 2 : .5, n = this.declaration.calculate({zoom: o > e ? o - 1 : o + 1}, i), r = this.declaration.calculate({zoom: o}, i), s = Math.min((Date.now() - this.zoomHistory.lastIntegerZoomTime) / this.duration, 1), l = Math.abs(o - e), u = interpolate(s, 1, l);
                return void 0 !== n && void 0 !== r ? {from: n, fromScale: a, to: r, toScale: 1, t: u} : void 0
            }, module.exports = StyleTransition;
        }, {"../util/interpolate": 119, "../util/util": 127}],
        ...
        }, {"mapbox-gl-style-spec/lib/validate_style.min": 186}],
        ...
        76: [function (require, module, exports) {
            "use strict";
            var createStructArrayType = require("../util/struct_array"), Point = require("point-geometry"), CollisionBoxArray = createStructArrayType({
                members: [{
                    type: "Int16",
                    name: "anchorPointX"
        ...
        }, {"../util/struct_array": 125, "point-geometry": 194}],
        77: [function (require, module, exports) {
            ...
            CollisionFeature.prototype._addLineCollisionBoxes = function (t, e, i, o, s, a, n, r, l) {
                ...
                for (var b = e[m].dist(e[m + 1]), v = 0; v < u; v++) {
                    ...
                    var g = c - _, p = e[m], C = e[m + 1], B = C.sub(p)._unit()._mult(g)._add(p)._round(), M = Math.max(Math.abs(c - h) - d / 2, 0), y = s / 2 / M;
        ...
        78: [function (require, module, exports) {
            "use strict";
            var Point = require("point-geometry"), EXTENT = require("../data/extent"), Grid = require("grid-index"), intersectionTests = require("../util/intersection_tests"), CollisionTile = function (t, e, i) {
                if ("object" == typeof t) {
                    var r = t;
            ...
            CollisionTile.prototype.serialize = function (t) {
                ...
                return t && (t.push(e), t.push(i)), {angle: this.angle, pitch: this.pitch, grid: e, ignoredGrid: i}
                ...
                for (var r = this, a = this.collisionBoxArray, o = this.minScale, n = this.rotationMatrix, l = this.yStretch, h = t.boxStartIndex; h < t.boxEndIndex; h++) {
                    var s = a.get(h), x = s.anchorPoint._matMult(n), c = x.x, g = x.y, y = c + s.x1, d = g + s.y1 * l, m = c + s.x2, u = g + s.y2 * l;
                    if (s.bbox0 = y, s.bbox1 = d, s.bbox2 = m, s.bbox3 = u, !e)for (var p = r.grid.query(y, d, m, u), M = 0; M < p.length; M++) {
                    ...
                    if (i) {
                        var S;
                        if (r.angle) {
                            var P = r.reverseRotationMatrix, b = new Point(s.x1, s.y1).matMult(P), T = new Point(s.x2, s.y1).matMult(P), w = new Point(s.x1, s.y2).matMult(P), N = new Point(s.x2, s.y2).matMult(P);
                ...
                for (var a = this.collisionBoxArray, o = this.rotationMatrix, n = this.yStretch, l = [], h = 1 / 0, s = 1 / 0, x = -(1 / 0), c = -(1 / 0), g = 0; g < t.length; g++)for (var y = t[g], d = 0; d < y.length; d++) {
                    var m = y[d].matMult(o);
                ...
                for (var f = Math.pow(2, Math.ceil(Math.log(e) / Math.LN2 * 10) / 10), v = 0; v < u.length; v++) {
                    ...
                    if (void 0 === i[P] && (i[P] = {}), !i[P][b] && !(f < S.placementScale || f > S.maxScale)) {
                        var T = S.anchorPoint.matMult(o), w = T.x + S.x1 / e, N = T.y + S.y1 / e * n, B = T.x + S.x2 / e, G = T.y + S.y2 / e * n, E = [new Point(w, N), new Point(B, N), new Point(B, G), new Point(w, G)];
                ...
                var o = e.x - r.x, n = e.y - r.y, l = (a.x1 - i.x2) / o, h = (a.x2 - i.x1) / o, s = (a.y1 - i.y2) * this.yStretch / n, x = (a.y2 - i.y1) * this.yStretch / n;
        ...
        }, {"../data/extent": 11, "../util/intersection_tests": 120, "grid-index": 146, "point-geometry": 194}],
        ...
        }, {"../symbol/anchor": 73, "../util/interpolate": 119, "./check_max_angle": 74}],
        80: [function (require, module, exports) {
            "use strict";
            var ShelfPack = require("shelf-pack"), util = require("../util/util"), SIZE_GROWTH_RATE = 4, DEFAULT_SIZE = 128, MAX_SIZE = 2048, GlyphAtlas = function () {
            ...
            GlyphAtlas.prototype.getGlyphs = function () {
                ...
                var a = e.width + 2 * h, n = e.height + 2 * h, E = 1, T = a + 2 * E, u = n + 2 * E;
                T += 4 - T % 4, u += 4 - u % 4;
                ...
                for (var d = this.data, A = e.bitmap, _ = 0; _ < n; _++)for (var p = r.width * (l.y + _ + E) + l.x + E, o = a * _, R = 0; R < a; R++)d[p + R] = A[o + R];
                ...
                if (!(i >= MAX_SIZE || e >= MAX_SIZE)) {
                    ...
                    for (var h = new ArrayBuffer(this.width * this.height), r = 0; r < e; r++) {
                        var s = new Uint8Array(t.data.buffer, e * r, i), a = new Uint8Array(h, e * r * SIZE_GROWTH_RATE, i);
                        a.set(s)
                    }
        ...
        81: [function (require, module, exports) {
            ...
            var normalizeURL = require("../util/mapbox").normalizeGlyphsURL, ajax = require("../util/ajax"), verticalizePunctuation = require("../util/verticalize_punctuation"), Glyphs = require("../util/glyphs"), GlyphAtlas = require("../symbol/glyph_atlas"), Protobuf = require("pbf"), SimpleGlyph = function (t, e, a) {
                var l = 1;
            ...
            GlyphSource.prototype.getSimpleGlyphs = function (t, e, a, l) {
                ...
                if (l[e]) l[e].push(a); else {
                    ...
                    ajax.getArrayBuffer(r, function (t, a) {
                        for (var i = !t && new Glyphs(new Protobuf(a)), r = 0; r < l[e].length; r++)l[e][r](t, e, i);
                        delete l[e]
                    })
                }
            ...
            "../symbol/glyph_atlas": 80,
            "../util/ajax": 107,
            "../util/glyphs": 118,
            "../util/mapbox": 123,
            "../util/verticalize_punctuation": 129,
            "pbf": 193
        }],
        ...
        83: [function (require, module, exports) {
            ...
            function getIconQuads(t, e, a, n, i, o, l, h, r) {
                var s, g, u, c, m = e.image.rect, f = i.layout, x = 1, d = e.left - x, P = d + m.w / e.image.pixelRatio, y = e.top - x, M = y + m.h / e.image.pixelRatio;
                if ("none" !== f["icon-text-fit"] && l) {
                    var p = P - d, v = M - y, w = f["text-size"] / 24, S = l.left * w, b = l.right * w, I = l.top * w, _ = l.bottom * w, Q = b - S, G = _ - I, k = f["icon-text-fit-padding"][0], q = f["icon-text-fit-padding"][1], A = f["icon-text-fit-padding"][2], R = f["icon-text-fit-padding"][3], z = "width" === f["icon-text-fit"] ? .5 * (G - v) : 0, L = "height" === f["icon-text-fit"] ? .5 * (Q - p) : 0, V = "width" === f["icon-text-fit"] || "both" === f["icon-text-fit"] ? Q : p, j = "height" === f["icon-text-fit"] || "both" === f["icon-text-fit"] ? G : v;
            ...
            function getGlyphQuads(t, e, a, n, i, o) {
                for (var l = i.layout["text-rotate"] * Math.PI / 180, h = i.layout["text-keep-upright"], r = e.positionedGlyphs, s = [], g = 0; g < r.length; g++) {
                    ...
                    if (c) {
                        var m = c.rect;
                        if (m) {
                            var f, x = (u.x + c.advance / 2) * a, d = minScale;
                            ...
                            var P = u.x + c.left, y = u.y - c.top, M = P + m.w, p = y + m.h, v = new Point(u.x, c.advance / 2), w = new Point(P, y), S = new Point(M, y), b = new Point(P, p), I = new Point(M, p);
                            ...
                            for (var _ = 0; _ < f.length; _++) {
                                var Q = f[_], G = w, k = S, q = b, A = I;
                                if (l) {
                                    var R = Math.sin(l), z = Math.cos(l), L = [z, -R, R, z];
                                    G = G.matMult(L), k = k.matMult(L), q = q.matMult(L), A = A.matMult(L)
                                }
                                var V = Math.max(Q.minScale, d), j = (t.angle + Q.offset + 2 * Math.PI) % (2 * Math.PI), B = (Q.angle + Q.offset + 2 * Math.PI) % (2 * Math.PI);
        ...
        85: [function (require, module, exports) {
            ...
            function shapeText(e, t, i, n, a, r, o, s, h, l, c) {
                e = e.trim(), c === WritingMode.vertical && (e = verticalizePunctuation(e));
                var u = [], d = new Shaping(u, e, h[1], h[1], h[0], h[0], c), p = c === WritingMode.horizontal && i ? breakLines(e, determineLineBreaks(e, s, i, t)) : [e];
                return shapeLines(d, t, p, n, a, r, o, h, c, s, l), !!u.length && d
            }
            ...
            function calculateBadness(e, t, i, n) {
                ...
                return n && e < t ? Math.max(0, a - 150) : a + Math.abs(i) * i
            }

            function calculatePenalty(e, t) {
                var i = 0;
                return 10 === e && (i -= 1e4), !t || 40 !== t && 65288 !== t || (i += 50), 41 !== e && 65289 !== e || (i += 50), i
            }

            function evaluateBreak(e, t, i, n, a, r) {
                for (var o = [], s = 0, h = n; s < h.length; s += 1) {
                    var l = h[s], c = t - l.x;
                    o.push({priorBreak: l, badness: calculateBadness(c, i, a, r) + l.badness})
                }
                return o.push({priorBreak: null, badness: calculateBadness(t, i, a, r)}), o.sort(function (e, t) {
                    return e.badness - t.badness
                }), {index: e, x: t, priorBreak: o[0].priorBreak, badness: o[0].badness}
            }
            ...
            function determineLineBreaks(e, t, i, n) {
                ...
                for (var a = [], r = determineAverageLineWidth(e, t, i, n), o = 0, s = 0; s < e.length; s++) {
                    ...
                    if (l || h === newLine) {
                        if (breakable[h] || scriptDetection.charAllowsIdeographicBreaking(h)) {
                            var c = e.charCodeAt(s - 1);
                            a.unshift(evaluateBreak(s, o, r, a, calculatePenalty(h, c), !1))
                        }
                        l && (o += l.advance + t)
                    }
                }
                return a.unshift(evaluateBreak(e.length, o, r, a, 0, !0)), leastBadBreaks(a.shift())
            }

            function shapeLines(e, t, i, n, a, r, o, s, h, l, c) {
                var u = -17, d = 0, p = u, f = 0, g = e.positionedGlyphs;
                for (var v in i) {
                    var b = i[v].trim();
                    if (b.length) {
                        for (var B = g.length, k = 0; k < b.length; k++) {
                            var x = b.charCodeAt(k), m = t[x];
                            m && (scriptDetection.charHasUprightVerticalOrientation(x) && h !== WritingMode.horizontal ? (g.push(new PositionedGlyph(x, d, 0, m, -Math.PI / 2)), d += c + l) : (g.push(new PositionedGlyph(x, d, p, m, 0)), d += m.advance + l))
                        }
                        if (g.length !== B) {
                            var M = d - l;
                            f = Math.max(M, f), justifyLine(g, t, B, g.length - 1, o)
                        }
                        d = 0, p += n
                    } else p += n
                }
                align(g, o, a, r, f, n, i.length, s);
                var L = i.length * n;
                e.top += -r * L, e.bottom = e.top + L, e.left += -a * f, e.right = e.left + f
            }
            ...
            function align(e, t, i, n, a, r, o, s) {
                for (var h = (t - i) * a + s[0], l = (-n * o + .5) * r + s[1], c = 0; c < e.length; c++)e[c].x += h, e[c].y += l
            }

            function shapeIcon(e, t) {
                if (!e || !e.rect)return null;
                var i = t[0], n = t[1], a = i - e.width / 2, r = a + e.width, o = n - e.height / 2, s = o + e.height;
            ...
            var scriptDetection = require("../util/script_detection"), verticalizePunctuation = require("../util/verticalize_punctuation"), WritingMode = {
                horizontal: 1,
                vertical: 2
            };
            module.exports = {shapeText: shapeText, shapeIcon: shapeIcon, WritingMode: WritingMode};
            var newLine = 10, breakable = {
                32: !0,
                38: !0,
                40: !0,
                41: !0,
            ...
            breakable[newLine] = !0;
        }, {"../util/script_detection": 124, "../util/verticalize_punctuation": 129}],
        86: [function (require, module, exports) {
            "use strict";
            function copyBitmap(t, i, e, h, a, s, r, o, l, p, n) {
                var u, R, f = h * i + e, x = o * s + r;
                if (n)for (x -= s, R = -1; R <= p; R++, f = ((R + p) % p + h) * i + e, x += s)for (u = -1; u <= l; u++)a[x + u] = t[f + (u + l) % l]; else for (R = 0; R < p; R++, f += i, x += s)for (u = 0; u < l; u++)a[x + u] = t[f + u]
            }

            var ShelfPack = require("shelf-pack"), browser = require("../util/browser"), util = require("../util/util"), AtlasImage = function (t, i, e, h, a) {
            ...
            SpriteAtlas.prototype.allocateImage = function (t, i) {
                ...
                var t = this;
                if (!this.data) {
                    var i = Math.floor(this.width * this.pixelRatio), e = Math.floor(this.height * this.pixelRatio);
        ...
        }, {"../util/browser": 108, "../util/util": 127, "shelf-pack": 197}],
        87: [function (require, module, exports) {
            "use strict";
            var createStructArrayType = require("../util/struct_array"), Point = require("point-geometry"), SymbolInstancesArray = createStructArrayType({
                members: [{
                    type: "Uint16",
        ...
        88: [function (require, module, exports) {
            "use strict";
            var createStructArrayType = require("../util/struct_array"), Point = require("point-geometry"), SymbolQuad = require("./quads").SymbolQuad, SymbolQuadsArray = createStructArrayType({
                members: [{
                    type: "Int16",
                    name: "anchorPointX"
        ...
        }, {"../util/struct_array": 125, "./quads": 83, "point-geometry": 194}],
        89: [function (require, module, exports) {
            ...
            module.exports = function (e, t) {
                ...
                for (var q in handlers)e[q] = new handlers[q](e, t), t.interactive && t[q] && e[q].enable();
            ...
            "../util/dom": 115,
            "./handler/box_zoom": 95,
            "./handler/dblclick_zoom": 96,
            "./handler/drag_pan": 97,
            "./handler/drag_rotate": 98,
            "./handler/keyboard": 99,
            "./handler/scroll_zoom": 100,
            "./handler/touch_zoom_rotate": 101,
            "point-geometry": 194
        }],
        90: [function (require, module, exports) {
            "use strict";
            var util = require("../util/util"), interpolate = require("../util/interpolate"), browser = require("../util/browser"), LngLat = require("../geo/lng_lat"), LngLatBounds = require("../geo/lng_lat_bounds"), Point = require("point-geometry"), Evented = require("../util/evented"), Camera = function (t) {
                function i(i, e) {
                    t.call(this), this.transform = i, this._bearingSnap = e.bearingSnap
                }
                ...
                return t && (i.__proto__ = t), i.prototype = Object.create(t && t.prototype), i.prototype.constructor = i, i.prototype.getCenter = function () {
                    ...
                    var o = Point.convert(i.offset), n = this.transform, r = n.project(t.getNorthWest()), s = n.project(t.getSouthEast()), a = s.sub(r), h = (n.width - 2 * i.padding - 2 * Math.abs(o.x)) / a.x, u = (n.height - 2 * i.padding - 2 * Math.abs(o.y)) / a.y;
                    ...
                    var o, n, r = this.transform, s = Point.convert(t.offset), a = this.getZoom(), h = this.getBearing(), u = this.getPitch(), p = "zoom" in t ? +t.zoom : a, c = "bearing" in t ? this._normalizeBearing(t.bearing, h) : h, m = "pitch" in t ? +t.pitch : u;
                    ...
                    return t.animate === !1 && (t.duration = 0), this.zooming = p !== a, this.rotating = h !== c, this.pitching = m !== u, t.smoothEasing && 0 !== t.duration && (t.easing = this._smoothOutEasing(t.duration)), t.noMoveStart || this.fire("movestart", i), this.zooming && this.fire("zoomstart", i), clearTimeout(this._onEaseEnd), this._ease(function (t) {
                    ...
                    var i = this.zooming;
                    this.zooming = !1, this.rotating = !1, this.pitching = !1, i && this.fire("zoomend", t), this.fire("moveend", t)
                    ...
                    var s = this.transform, a = Point.convert(t.offset), h = this.getZoom(), u = this.getBearing(), p = this.getPitch(), c = "center" in t ? LngLat.convert(t.center) : this.getCenter(), m = "zoom" in t ? +t.zoom : h, g = "bearing" in t ? this._normalizeBearing(t.bearing, u) : u, f = "pitch" in t ? +t.pitch : p;
                    Math.abs(s.center.lng) + Math.abs(c.lng) > 180 && (s.center.lng > 0 && c.lng < 0 ? c.lng += 360 : s.center.lng < 0 && c.lng > 0 && (c.lng -= 360));
                    var d = s.zoomScale(m - h), l = s.point, v = "center" in t ? s.project(c).sub(a.div(d)) : l, b = t.curve, z = Math.max(s.width, s.height), y = z / d, _ = v.sub(l).mag();
                    if ("minZoom" in t) {
                        var M = util.clamp(Math.min(t.minZoom, h, m), s.minZoom, s.maxZoom), T = z / s.zoomScale(M - h);
                        b = Math.sqrt(T / _ * 2)
                    }
                    ...
                    return this.zooming = !0, u !== g && (this.rotating = !0), p !== f && (this.pitching = !0), this.fire("movestart", i), this.fire("zoomstart", i), this._ease(function (t) {
                        ...
                        this.zooming = !1, this.rotating = !1, this.pitching = !1, this.fire("zoomend", i), this.fire("moveend", i)
                    }, t), this
                    ...
                    var i = util.ease;
                    if (this._prevEase) {
                        var e = this._prevEase, o = (Date.now() - e.start) / e.duration, n = e.easing(o + .01) - e.easing(o), r = .27 / Math.sqrt(n * n + 1e-4) * .01, s = Math.sqrt(.0729 - r * r);
        ...
        91: [function (require, module, exports) {
            "use strict";
            var DOM = require("../../util/dom"), util = require("../../util/util"), AttributionControl = function (t) {
            ...
            AttributionControl.prototype.getDefaultPosition = function () {
                ...
                if (this._map.style) {
                    var t = [], i = this._map.style.sourceCaches;
                    for (var o in i) {
                        var n = i[o].getSource();
                    ...
                    t.sort(function (t, i) {
                        ...
                        for (var n = o + 1; n < t.length; n++)if (t[n].indexOf(i) >= 0)return !1;
                        return !0
        ...
        92: [function (require, module, exports) {
            ...
            var Evented = require("../../util/evented"), DOM = require("../../util/dom"), window = require("../../util/window"), util = require("../../util/util"), defaultGeoPositionOptions = {
        ...
        }, {"../../util/dom": 115, "../../util/evented": 116, "../../util/util": 127, "../../util/window": 110}],
        93: [function (require, module, exports) {
            ...
            var DOM = require("../../util/dom"), window = require("../../util/window"), util = require("../../util/util"), className = "mapboxgl-ctrl", NavigationControl = function () {
        ...
        }, {"../../util/dom": 115, "../../util/util": 127, "../../util/window": 110}],
        94: [function (require, module, exports) {
            "use strict";
            function updateScale(t, e, o) {
                var n = o && o.maxWidth || 100, i = t._container.clientHeight / 2, a = getDistance(t.unproject([0, i]), t.unproject([n, i]));
            ...
            function getDistance(t, e) {
                var o = 6371e3, n = Math.PI / 180, i = t.lat * n, a = e.lat * n, r = Math.sin(i) * Math.sin(a) + Math.cos(i) * Math.cos(a) * Math.cos((e.lng - t.lng) * n), l = o * Math.acos(Math.min(r, 1));
                return l
            }
            ...
            var DOM = require("../../util/dom"), util = require("../../util/util"), ScaleControl = function (t) {
        ...
        95: [function (require, module, exports) {
            "use strict";
            var DOM = require("../../util/dom"), LngLatBounds = require("../../geo/lng_lat_bounds"), util = require("../../util/util"), window = require("../../util/window"), BoxZoomHandler = function (o) {
            ...
            BoxZoomHandler.prototype.isEnabled = function () {
                ...
                var n = Math.min(e.x, t.x), i = Math.max(e.x, t.x), s = Math.min(e.y, t.y), r = Math.max(e.y, t.y);
        ...
        }, {"../../geo/lng_lat_bounds": 20, "../../util/dom": 115, "../../util/util": 127, "../../util/window": 110}],
        ...
        97: [function (require, module, exports) {
            "use strict";
            var DOM = require("../../util/dom"), util = require("../../util/util"), window = require("../../util/window"), inertiaLinearity = .3, inertiaEasing = util.bezier(0, 0, inertiaLinearity, 1), inertiaMaxSpeed = 1400, inertiaDeceleration = 2500, DragPanHandler = function (t) {
            ...
            DragPanHandler.prototype.isEnabled = function () {
                ...
                this._ignoreEvent(t) || this.isActive() || (t.touches ? (window.document.addEventListener("touchmove", this._onMove), window.document.addEventListener("touchend", this._onTouchEnd)) : (window.document.addEventListener("mousemove", this._onMove), window.document.addEventListener("mouseup", this._onMouseUp)), this._active = !1, this._startPos = this._pos = DOM.mousePos(this._el, t), this._inertia = [[Date.now(), this._pos]])
                ...
                if (this.isActive()) {
                    ...
                    var u = a.mult(inertiaLinearity / s), h = u.mag();
                    h > inertiaMaxSpeed && (h = inertiaMaxSpeed, u._unit()._mult(h));
                    var d = h / (inertiaDeceleration * inertiaLinearity), v = u.mult(-d / 2);
                    this._map.panBy(v, {duration: 1e3 * d, easing: inertiaEasing, noMoveStart: !0}, {originalEvent: t})
                }
        ...
        98: [function (require, module, exports) {
            "use strict";
            var DOM = require("../../util/dom"), util = require("../../util/util"), window = require("../../util/window"), inertiaLinearity = .25, inertiaEasing = util.bezier(0, 0, inertiaLinearity, 1), inertiaMaxSpeed = 180, inertiaDeceleration = 720, DragRotateHandler = function (t, e) {
            ...
            DragRotateHandler.prototype.isEnabled = function () {
                ...
                this._ignoreEvent(t) || this.isActive() || (window.document.addEventListener("mousemove", this._onMove), window.document.addEventListener("mouseup", this._onUp), this._active = !1, this._inertia = [[Date.now(), this._map.getBearing()]], this._startPos = this._pos = DOM.mousePos(this._el, t), this._center = this._map.transform.centerPoint, t.preventDefault())
                ...
                if (!this._ignoreEvent(t)) {
                    ...
                    var e = this._map;
                    e.stop();
                    var i = this._pos, n = DOM.mousePos(this._el, t), r = .8 * (i.x - n.x), a = (i.y - n.y) * -.5, o = e.getBearing() - r, s = e.getPitch() - a, h = this._inertia, _ = h[h.length - 1];
                ...
                if (!this._ignoreEvent(t) && (window.document.removeEventListener("mousemove", this._onMove), window.document.removeEventListener("mouseup", this._onUp), this.isActive())) {
                    ...
                    var i = this._map, n = i.getBearing(), r = this._inertia, a = function () {
                        Math.abs(n) < e._bearingSnap ? i.resetNorth({noMoveStart: !0}, {originalEvent: t}) : e._fireEvent("moveend", t)
                    };
                    if (r.length < 2)return void a();
                    var o = r[0], s = r[r.length - 1], h = r[r.length - 2], _ = i._normalizeBearing(n, h[1]), v = s[1] - o[1], u = v < 0 ? -1 : 1, d = (s[0] - o[0]) / 1e3;
                    if (0 === v || 0 === d)return void a();
                    var l = Math.abs(v * (inertiaLinearity / d));
                    l > inertiaMaxSpeed && (l = inertiaMaxSpeed);
                    var p = l / (inertiaDeceleration * inertiaLinearity), g = u * l * (p / 2);
        ...
        100: [function (require, module, exports) {
            "use strict";
            var DOM = require("../../util/dom"), util = require("../../util/util"), browser = require("../../util/browser"), window = require("../../util/window"), ua = window.navigator.userAgent.toLowerCase(), firefox = ua.indexOf("firefox") !== -1, safari = ua.indexOf("safari") !== -1 && ua.indexOf("chrom") === -1, ScrollZoomHandler = function (e) {
            ...
            ScrollZoomHandler.prototype.isEnabled = function () {
                return !!this._enabled
            }, ScrollZoomHandler.prototype.enable = function () {
        ...
        101: [function (require, module, exports) {
            "use strict";
            var DOM = require("../../util/dom"), util = require("../../util/util"), window = require("../../util/window"), inertiaLinearity = .15, inertiaEasing = util.bezier(0, 0, inertiaLinearity, 1), inertiaDeceleration = 12, inertiaMaxSpeed = 2.5, significantScaleThreshold = .15, significantRotateThreshold = 4, TouchZoomRotateHandler = function (t) {
            ...
            TouchZoomRotateHandler.prototype.isEnabled = function () {
                return !!this._enabled
            }, TouchZoomRotateHandler.prototype.enable = function () {
                ...
                if (2 === t.touches.length) {
                    ...
                    this._startVec = e.sub(i), this._startScale = this._map.transform.scale, this._startBearing = this._map.transform.bearing, this._gestureIntent = void 0, this._inertia = [], window.document.addEventListener("touchmove", this._onMove, !1), window.document.addEventListener("touchend", this._onEnd, !1)
                }
            }, TouchZoomRotateHandler.prototype._onMove = function (t) {
                if (2 === t.touches.length) {
                    var e = DOM.mousePos(this._el, t.touches[0]), i = DOM.mousePos(this._el, t.touches[1]), o = e.add(i).div(2), n = e.sub(i), a = n.mag() / this._startVec.mag(), r = this._rotationDisabled ? 0 : 180 * n.angleWith(this._startVec) / Math.PI, s = this._map;
                    if (this._gestureIntent) {
                        var h = {duration: 0, around: s.unproject(o)};
                        "rotate" === this._gestureIntent && (h.bearing = this._startBearing + r), "zoom" !== this._gestureIntent && "rotate" !== this._gestureIntent || (h.zoom = s.transform.scaleZoom(this._startScale * a)), s.stop(), this._drainInertiaBuffer(), this._inertia.push([Date.now(), a, o]), s.easeTo(h, {originalEvent: t})
                    } else {
                        var u = Math.abs(1 - a) > significantScaleThreshold, l = Math.abs(r) > significantRotateThreshold;
                ...
                var o = e[e.length - 1], n = e[0], a = i.transform.scaleZoom(this._startScale * o[1]), r = i.transform.scaleZoom(this._startScale * n[1]), s = a - r, h = (o[0] - n[0]) / 1e3, u = o[2];
                if (0 === h || a === r)return void i.snapToNorth({}, {originalEvent: t});
        ...
        102: [function (require, module, exports) {
            ...
            Hash.prototype.addTo = function (t) {
                ...
                var t = this._map.getCenter(), e = this._map.getZoom(), a = this._map.getBearing(), h = this._map.getPitch(), i = Math.max(0, Math.ceil(Math.log(e) / Math.LN2)), n = "#" + Math.round(100 * e) / 100 + "/" + t.lat.toFixed(i) + "/" + t.lng.toFixed(i);
                (a || h) && (n += "/" + Math.round(10 * a) / 10), h && (n += "/" + Math.round(h)), window.history.replaceState("", "", n)
            }, module.exports = Hash;
        }, {"../util/util": 127, "../util/window": 110}],
        103: [function (require, module, exports) {
            ...
            var util = require("../util/util"), browser = require("../util/browser"), window = require("../util/window"), DOM = require("../util/dom"), Style = require("../style/style"), AnimationLoop = require("../style/animation_loop"), Painter = require("../render/painter"), Transform = require("../geo/transform"), Hash = require("./hash"), bindHandlers = require("./bind_handlers"), Camera = require("./camera"), LngLat = require("../geo/lng_lat"), LngLatBounds = require("../geo/lng_lat_bounds"), Point = require("point-geometry"), AttributionControl = require("./control/attribution_control"), isSupported = require("mapbox-gl-supported"), defaultMinZoom = 0, defaultMaxZoom = 20, defaultOptions = {
                center: [0, 0],
                zoom: 0,
                bearing: 0,
                pitch: 0,
                ...
                function e(e) {
                    ...
                    var o = new Transform(e.minZoom, e.maxZoom);
                ...
                return e.prototype.addControl = function (t, e) {
                    ...
                    var i = t.onAdd(this), o = this._controlPositions[e];
                    ...
                    var t = this._containerDimensions(), e = t[0], i = t[1];
                    return this._resizeCanvas(e, i), this.transform.resize(e, i), this.painter.resize(e, i), this.fire("movestart").fire("move").fire("resize").fire("moveend")
                    ...
                    var o = this._controlContainer = DOM.create("div", "mapboxgl-control-container", t), s = this._controlPositions = {};
            ...
            "./bind_handlers": 89,
            "./camera": 90,
            "./control/attribution_control": 91,
            "./hash": 102,
            "mapbox-gl-supported": 190,
            "point-geometry": 194
        }],
        104: [function (require, module, exports) {
            "use strict";
            var DOM = require("../util/dom"), LngLat = require("../geo/lng_lat"), Point = require("point-geometry"), Marker = function (t, e) {
        ...
        }, {"../geo/lng_lat": 19, "../util/dom": 115, "point-geometry": 194}],
        105: [function (require, module, exports) {
            ...
            var util = require("../util/util"), Evented = require("../util/evented"), DOM = require("../util/dom"), LngLat = require("../geo/lng_lat"), Point = require("point-geometry"), window = require("../util/window"), defaultOptions = {
                closeButton: !0,
                closeOnClick: !0
            }, Popup = function (t) {
                function o(o) {
                ...
                return t && (o.__proto__ = t), o.prototype = Object.create(t && t.prototype), o.prototype.constructor = o, o.prototype.addTo = function (t) {
                    ...
                    if (this._map && this._lngLat && this._content) {
                        ...
                        var t = this.options.anchor, o = normalizeOffset(this.options.offset), e = this._map.project(this._lngLat).round();
                        if (!t) {
        ...
        107: [function (require, module, exports) {
            ...
            function sameOrigin(e) {
                ...
                return n.href = e, n.protocol === window.document.location.protocol && n.host === window.document.location.host
            }

            var window = require("./window");
            exports.getJSON = function (e, n) {
                var t = new window.XMLHttpRequest;
                return t.open("GET", e, !0), t.setRequestHeader("Accept", "application/json"), t.onerror = function (e) {
                    n(e)
                }, t.onload = function () {
                    if (t.status >= 200 && t.status < 300 && t.response) {
                        var e;
                        try {
                        ...
                        n(null, e)
                    } else n(new Error(t.statusText))
                }, t.send(), t
            }, exports.getArrayBuffer = function (e, n) {
                var t = new window.XMLHttpRequest;
                return t.open("GET", e, !0), t.responseType = "arraybuffer", t.onerror = function (e) {
                    n(e)
                }, t.onload = function () {
                    return 0 === t.response.byteLength && 200 === t.status ? n(new Error("http status 200 returned without content.")) : void(t.status >= 200 && t.status < 300 && t.response ? n(null, t.response) : n(new Error(t.statusText)))
                }, t.send(), t
            };
            var transparentPngUrl = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAC0lEQVQYV2NgAAIAAAUAAarVyFEAAAAASUVORK5CYII=";
            exports.getImage = function (e, n) {
                return exports.getArrayBuffer(e, function (e, t) {
                    if (e)return n(e);
                    var r = new window.Image, o = window.URL || window.webkitURL;
                    r.onload = function () {
                        n(null, r), o.revokeObjectURL(r.src)
                    };
                    var s = new window.Blob([new Uint8Array(t)], {type: "image/png"});
                    r.src = t.byteLength ? o.createObjectURL(s) : transparentPngUrl
                })
            }, exports.getVideo = function (e, n) {
                var t = window.document.createElement("video");
                t.onloadstart = function () {
                    n(null, t)
                };
                for (var r = 0; r < e.length; r++) {
                    var o = window.document.createElement("source");
                    sameOrigin(e[r]) || (t.crossOrigin = "Anonymous"), o.src = e[r], t.appendChild(o)
                }
                return t
            };
        }, {"./window": 110}],
        ...
        }, {"./window": 110, "mapbox-gl-supported": 190}],
        109: [function (require, module, exports) {
            "use strict";
            var WebWorkify = require("webworkify"), window = require("../window"), workerURL = window.URL.createObjectURL(new WebWorkify(require("../../source/worker"), {bare: !0}));
            module.exports = function () {
                return new window.Worker(workerURL)
            };
        }, {"../../source/worker": 55, "../window": 110, "webworkify": 211}],
        ...
        111: [function (require, module, exports) {
            ...
            var quickselect = require("quickselect"), calculateSignedArea = require("./util").calculateSignedArea;
            module.exports = function (e, r) {
                var a = e.length;
                if (a <= 1)return [e];
        ...
        115: [function (require, module, exports) {
            ...
            var docStyle = window.document.documentElement.style, selectProp = testProp(["userSelect", "MozUserSelect", "WebkitUserSelect", "msUserSelect"]), userSelect;
        ...
        117: [function (require, module, exports) {
            ...
            function pointToPolygonDist(e, t) {
                for (var n = !1, r = 1 / 0, o = 0; o < t.length; o++)for (var l = t[o], i = 0, s = l.length, u = s - 1; i < s; u = i++) {
                    var a = l[i], h = l[u];
            ...
            function getCentroidCell(e) {
                for (var t = 0, n = 0, r = 0, o = e[0], l = 0, i = o.length, s = i - 1; l < i; s = l++) {
                    var u = o[l], a = o[s], h = u.x * a.y - a.x * u.y;
                    n += (u.x + a.x) * h, r += (u.y + a.y) * h, t += 3 * h
                }
                return new Cell(n / t, r / t, 0, e)
            }

            var Queue = require("tinyqueue"), Point = require("point-geometry"), distToSegmentSquared = require("./intersection_tests").distToSegmentSquared;
            module.exports = function (e, t, n) {
                ...
                for (var h = l - r, p = i - o, y = Math.min(h, p), x = y / 2, d = new Queue(null, compareMax), g = r; g < l; g += y)for (var f = o; f < i; f += y)d.push(new Cell(g + x, f + x, x, e));
        ...
        }, {"./intersection_tests": 120, "point-geometry": 194, "tinyqueue": 199}],
        ...
        123: [function (require, module, exports) {
            ...
            var config = require("./config"), browser = require("./browser"), help = "See https://www.mapbox.com/developers/api/#access-tokens";
            ...
            exports.normalizeTileURL = function (r, e, t) {
                ...
                var o = parseUrl(r), a = browser.devicePixelRatio >= 2 || 512 === t ? "@2x" : "", s = browser.supportsWebp ? ".webp" : "$1";
                return o.path = o.path.replace(imageExtensionRe, "" + a + s), replaceTempAccessToken(o.params), formatUrl(o)
            };
            var urlRe = /^(\w+):\/\/([^\/?]+)(\/[^?]+)?\??(.+)?/;
        }, {"./browser": 108, "./config": 112}],
        ...
        }, {"./is_char_in_unicode_block": 121}],
        125: [function (require, module, exports) {
            "use strict";
            function createStructArrayType(t) {
                var e = JSON.stringify(t);
                if (structArrayTypeCache[e])return structArrayTypeCache[e];
                var r = void 0 === t.alignment ? 1 : t.alignment, i = 0, n = 0, a = ["Uint8"], o = t.members.map(function (t) {
        ...
        127: [function (require, module, exports) {
            "use strict";
            var UnitBezier = require("unitbezier"), Coordinate = require("../geo/coordinate"), Point = require("point-geometry");
            exports.easeCubicInOut = function (r) {
                if (r <= 0)return 0;
                if (r >= 1)return 1;
                var e = r * r, n = e * r;
                return 4 * (r < .5 ? n : 3 * (r - e) + n - .75)
            }, exports.bezier = function (r, e, n, t) {
                var o = new UnitBezier(r, e, n, t);
                return function (r) {
                    return o.solve(r)
                }
            }, exports.ease = exports.bezier(.25, .1, .25, 1), exports.clamp = function (r, e, n) {
                ...
                var n = [];
                for (var t in r)t in e || n.push(t);
                return n
            }, exports.extend = function (r, e, n, t) {
            ...
            exports.uniqueId = function () {
                ...
                for (var e = 1 / 0, n = 1 / 0, t = -(1 / 0), o = -(1 / 0), a = 0; a < r.length; a++)e = Math.min(e, r[a].column), n = Math.min(n, r[a].row), t = Math.max(t, r[a].column), o = Math.max(o, r[a].row);
                var i = t - e, u = o - n, s = Math.max(i, u);
                return new Coordinate((e + t) / 2, (n + o) / 2, 0).zoomTo(Math.floor(-Math.log(s) / Math.LN2))
            }, exports.endsWith = function (r, e) {
                return r.indexOf(e, r.length - e.length) !== -1
            }, exports.mapObject = function (r, e, n) {
                var t = this, o = {};
                for (var a in r)o[a] = e.call(n || t, r[a], a, r);
                return o
            }, exports.filterObject = function (r, e, n) {
                var t = this, o = {};
                for (var a in r)e.call(n || t, r[a], a, r) && (o[a] = r[a]);
                return o
            }, exports.deepEqual = function (r, e) {
                if (Array.isArray(r)) {
                    if (!Array.isArray(e) || r.length !== e.length)return !1;
                    for (var n = 0; n < r.length; n++)if (!exports.deepEqual(r[n], e[n]))return !1;
                    return !0
                }
                ...
                for (var n = 0; n < r.length; n++)if (e.indexOf(r[n]) >= 0)return !0;
                return !1
            };
            var warnOnceHistory = {};
            exports.warnOnce = function (r) {
                ...
                for (var e, n, t = 0, o = 0, a = r.length, i = a - 1; o < a; i = o++)e = r[o], n = r[i], t += (n.x - e.x) * (e.y + n.y);
                return t
            }, exports.isClosedPolygon = function (r) {
                if (r.length < 4)return !1;
                var e = r[0], n = r[r.length - 1];
                return !(Math.abs(e.x - n.x) > 0 || Math.abs(e.y - n.y) > 0) && Math.abs(exports.calculateSignedArea(r)) > .01
            }, exports.sphericalToCartesian = function (r) {
                var e = r[0], n = r[1], t = r[2];
                return n += 90, n *= Math.PI / 180, t *= Math.PI / 180, [e * Math.cos(n) * Math.sin(t), e * Math.sin(n) * Math.sin(t), e * Math.cos(t)]
            };
        }, {"../geo/coordinate": 18, "point-geometry": 194, "unitbezier": 200}],
        ...
        129: [function (require, module, exports) {
            ...
            module.exports = function (t) {
                for (var o = "", e = 0; e < t.length; e++) {
                    var r = t.charCodeAt(e + 1) || null, l = t.charCodeAt(e - 1) || null, i = (!r || !scriptDetection.charHasRotatedVerticalOrientation(r) || module.exports.lookup[t[e + 1]]) && (!l || !scriptDetection.charHasRotatedVerticalOrientation(l) || module.exports.lookup[t[e - 1]]);
        ...
        131: [function (require, module, exports) {
            !function (t, r) {
                ...
                function s(t, r) {
                    var n = r[0], e = r[1], a = r[2], o = r[3], u = r[4], i = r[5], c = r[6], f = r[7], v = r[8], s = r[9], l = r[10], M = r[11], h = r[12], m = r[13], y = r[14], d = r[15], p = n * i - e * u, w = n * c - a * u, A = n * f - o * u, F = e * c - a * i, x = e * f - o * i, b = a * f - o * c, g = v * m - s * h, j = v * y - l * h, R = v * d - M * h, X = s * y - l * m, Z = s * d - M * m, k = l * d - M * y, q = p * k - w * Z + A * X + F * R - x * j + b * g;
                ...
                function l(t, r, n) {
                    var e = r[0], a = r[1], o = r[2], u = r[3], i = r[4], c = r[5], f = r[6], v = r[7], s = r[8], l = r[9], M = r[10], h = r[11], m = r[12], y = r[13], d = r[14], p = r[15], w = n[0], A = n[1], F = n[2], x = n[3];
                ...
                function m(t, r, n) {
                    var e = Math.sin(n), a = Math.cos(n), o = r[4], u = r[5], i = r[6], c = r[7], f = r[8], v = r[9], s = r[10], l = r[11];
                ...
                function y(t, r, n) {
                    var e = Math.sin(n), a = Math.cos(n), o = r[0], u = r[1], i = r[2], c = r[3], f = r[4], v = r[5], s = r[6], l = r[7];
                ...
                if (a !== -1 && t + 1 === r.length) {
                    ...
                    switch (n) {
                        ...
                        case"hsl":
                            ...
                            var i = (parseFloat(s[0]) % 360 + 360) % 360 / 360, u = parse_css_float(s[1]), g = parse_css_float(s[2]), d = g <= .5 ? g * (u + 1) : g + u - g * u, c = 2 * g - d;
        ...
        138: [function (require, module, exports) {
            ...
            function clipGeometry(e, r, t, n, u, i) {
                for (var l = [], s = 0; s < e.length; s++) {
                    var h, p, a, c = 0, o = 0, f = null, g = e[s], v = g.area, m = g.dist, w = g.outer, S = g.length, d = [];
        ...
        }, {"./clip": 138, "./convert": 139, "./tile": 143, "./transform": 144, "./wrap": 145}],
        ...
        150: [function (require, module, exports) {
            ...
            function select(t, a, o, s, r, e) {
                for (; r > s;) {
                    if (r - s > 600) {
                        var f = r - s + 1, p = o - s + 1, w = Math.log(f), m = .5 * Math.exp(2 * w / 3), n = .5 * Math.sqrt(w * m * (f - m) / f) * (p - f / 2 < 0 ? -1 : 1), c = Math.max(s, Math.floor(o - p * m / f + n)), h = Math.min(r, Math.floor(o + (f - p) * m / f + n));
                        select(t, a, o, c, h, e)
                    }
        ...
        152: [function (require, module, exports) {
            ...
            var isArray = require("lodash.isarray"), isTypedArray = require("lodash.istypedarray"), keys = require("lodash.keys"), argsTag = "[object Arguments]", arrayTag = "[object Array]", boolTag = "[object Boolean]", dateTag = "[object Date]", errorTag = "[object Error]", numberTag = "[object Number]", objectTag = "[object Object]", regexpTag = "[object RegExp]", stringTag = "[object String]", objectProto = Object.prototype, hasOwnProperty = objectProto.hasOwnProperty, objToString = objectProto.toString;
            module.exports = baseIsEqual;
        }, {"lodash.isarray": 156, "lodash.istypedarray": 157, "lodash.keys": 158}],
        ...
        157: [function (require, module, exports) {
            ...
            var MAX_SAFE_INTEGER = 9007199254740991, argsTag = "[object Arguments]", arrayTag = "[object Array]", boolTag = "[object Boolean]", dateTag = "[object Date]", errorTag = "[object Error]", funcTag = "[object Function]", mapTag = "[object Map]", numberTag = "[object Number]", objectTag = "[object Object]", regexpTag = "[object RegExp]", setTag = "[object Set]", stringTag = "[object String]", weakMapTag = "[object WeakMap]", arrayBufferTag = "[object ArrayBuffer]", dataViewTag = "[object DataView]", float32Tag = "[object Float32Array]", float64Tag = "[object Float64Array]", int8Tag = "[object Int8Array]", int16Tag = "[object Int16Array]", int32Tag = "[object Int32Array]", uint8Tag = "[object Uint8Array]", uint8ClampedTag = "[object Uint8ClampedArray]", uint16Tag = "[object Uint16Array]", uint32Tag = "[object Uint32Array]", typedArrayTags = {};
        ...
        158: [function (require, module, exports) {
            ...
            var getNative = require("lodash._getnative"), isArguments = require("lodash.isarguments"), isArray = require("lodash.isarray"), reIsUint = /^\d+$/, objectProto = Object.prototype, hasOwnProperty = objectProto.hasOwnProperty, nativeKeys = getNative(Object, "keys"), MAX_SAFE_INTEGER = 9007199254740991, getLength = baseProperty("length"), keys = nativeKeys ? function (e) {
                var t = null == e ? void 0 : e.constructor;
                return "function" == typeof t && t.prototype === e || "function" != typeof e && isArrayLike(e) ? shimKeys(e) : isObject(e) ? nativeKeys(e) : []
            } : shimKeys;
            module.exports = keys;
        }, {"lodash._getnative": 154, "lodash.isarguments": 155, "lodash.isarray": 156}],
        159: [function (require, module, exports) {
            ...
            function rgbToLab(r) {
                var t = rgb2xyz(r[0]), a = rgb2xyz(r[1]), n = rgb2xyz(r[2]), b = xyz2lab((.4124564 * t + .3575761 * a + .1804375 * n) / Xn), o = xyz2lab((.2126729 * t + .7151522 * a + .072175 * n) / Yn), g = xyz2lab((.0193339 * t + .119192 * a + .9503041 * n) / Zn);
            ...
            var Kn = 18, Xn = .95047, Yn = 1, Zn = 1.08883, t0 = 4 / 29, t1 = 6 / 29, t2 = 3 * t1 * t1, t3 = t1 * t1 * t1, deg2rad = Math.PI / 180, rad2deg = 180 / Math.PI;
        ...
        160: [function (require, module, exports) {
            ...
            function createFunction(t, o) {
                ...
                if (isFunctionDefinition(t)) {
                    var n, r = t.stops && "object" == typeof t.stops[0][0], i = r || void 0 !== t.property, s = r || !i, a = t.stops && typeof(r ? t.stops[0][0].property : t.stops[0][0]), p = t.type || o || ("string" === a ? "categorical" : "exponential");
                    if ("exponential" === p) n = evaluateExponentialFunction; else if ("interval" === p) n = evaluateIntervalFunction; else if ("categorical" === p) n = evaluateCategoricalFunction; else {
                    ...
                    if (n === evaluateCategoricalFunction)for (var f = Object.create(null), v = 0; v < t.stops.length; v++)f[t.stops[v][0]] = t.stops[v][1];
                    if (r) {
                        var y = {}, F = [];
                        for (l = 0; l < t.stops.length; l++) {
                            var d = t.stops[l];
                            void 0 === y[d[0].zoom] && (y[d[0].zoom] = {
                                zoom: d[0].zoom,
                                type: t.type,
                                property: t.property,
                                stops: []
                            }), y[d[0].zoom].stops.push([d[0].value, d[1]])
                        }
                        for (var h in y)F.push([y[h].zoom, createFunction(y[h])]);
                        e = function (o, e) {
                            return u(evaluateExponentialFunction({stops: F, base: t.base}, o)(o, e))
                        }, e.isFeatureConstant = !1, e.isZoomConstant = !1
                    } else s ? (e = function (o) {
                        return u(n === evaluateCategoricalFunction ? n(t, o, f) : n(t, o))
                    }, e.isFeatureConstant = !0, e.isZoomConstant = !1) : (e = function (o, e) {
                        return u(n === evaluateCategoricalFunction ? n(t, e[t.property], f) : n(t, e[t.property]))
            ...
            function evaluateCategoricalFunction(t, o, e) {
                var n = e[o];
                return void 0 === n ? t.stops[0][1] : n
            }

            function evaluateIntervalFunction(t, o) {
                var e = t.stops.length;
                if (1 === e)return t.stops[0][1];
                if (void 0 === o || null === o)return t.stops[e - 1][1];
                if (o <= t.stops[0][0])return t.stops[0][1];
                if (o >= t.stops[e - 1][0])return t.stops[e - 1][1];
                var n = binarySearchForIndex(t.stops, o);
                return t.stops[n][1]
            }

            function evaluateExponentialFunction(t, o) {
                var e = void 0 !== t.base ? t.base : 1, n = t.stops.length;
                if (1 === n)return t.stops[0][1];
                if (void 0 === o || null === o)return t.stops[n - 1][1];
                if (o <= t.stops[0][0])return t.stops[0][1];
                if (o >= t.stops[n - 1][0])return t.stops[n - 1][1];
                var r = binarySearchForIndex(t.stops, o);
                return interpolate(o, e, t.stops[r][0], t.stops[r + 1][0], t.stops[r][1], t.stops[r + 1][1])
            }
            ...
            function binarySearchForIndex(t, o) {
                for (var e, n = t.length, r = 0, i = n - 1, s = 0; r <= i;) {
                    if (s = Math.floor((r + i) / 2), e = t[s][0], e === o) {
                        s += 1;
                        break
                    }
                    e < o ? r = s + 1 : e > o && (i = s - 1)
        ...
        162: [function (require, module, exports) {
            ...
            function diffLayers(e, r, o) {
                e = e || [], r = r || [];
                var a, s, t, n, i, p, m, u = e.map(pluckId), l = r.map(pluckId), y = e.reduce(indexById, {}), c = r.reduce(indexById, {}), d = u.slice(), h = Object.create(null);
        ...
        164: [function (require, module, exports) {
            ...
            var refProperties = require("./util/ref_properties"), stringify = require("fast-stable-stringify");
            module.exports = groupByLayout;
        }, {"./util/ref_properties": 167, "fast-stable-stringify": 134}],
        ...
        169: [function (require, module, exports) {
            ...
            "../error/validation_error": 163,
            "../util/extend": 165,
            "../util/get_type": 166,
            "./validate_array": 170,
            "./validate_boolean": 171,
            "./validate_color": 172,
            "./validate_constants": 173,
            "./validate_enum": 174,
            "./validate_filter": 175,
            "./validate_function": 176,
            "./validate_layer": 178,
            "./validate_light": 180,
            "./validate_number": 181,
            "./validate_object": 182,
        ...
        }, {"../error/validation_error": 163, "../util/get_type": 166, "./validate": 169}],
        ...
        }, {"../error/validation_error": 163, "../util/get_type": 166}],
        ...
        }, {"../error/validation_error": 163, "../util/get_type": 166, "csscolorparser": 132}],
        ...
        }, {"../error/validation_error": 163, "../util/unbundle_jsonlint": 168}],
        175: [function (require, module, exports) {
            ...
            "../error/validation_error": 163,
            "../util/get_type": 166,
            "../util/unbundle_jsonlint": 168,
            "./validate_enum": 174
        }],
        176: [function (require, module, exports) {
            "use strict";
            var ValidationError = require("../error/validation_error"), getType = require("../util/get_type"), validate = require("./validate"), validateObject = require("./validate_object"), validateArray = require("./validate_array"), validateNumber = require("./validate_number"), unbundle = require("../util/unbundle_jsonlint");
            module.exports = function (e) {
                function t(e) {
                    if ("identity" === l)return [new ValidationError(e.key, e.value, 'identity function may not have a "stops" property')];
                    var t = [], a = e.value;
                ...
                function r(e) {
                    ...
                    return t = t.concat(validate({
                        ...
                        style: e.style,
                        styleSpec: e.styleSpec
                    })), "number" === getType(r[0]) && ("piecewise-constant" === n.function && r[0] % 1 !== 0 && t.push(new ValidationError(o + "[0]", r[0], "zoom level for piecewise-constant functions must be an integer")), 0 !== e.arrayIndex && r[0] < e.array[e.arrayIndex - 1][0] && t.push(new ValidationError(o + "[0]", r[0], "array stops must appear in ascending order"))), t
                }
                ...
                function a(e) {
                    ...
                    } else o = t, l || "string" !== t || (l = "categorical");
                    return "number" !== t && "string" !== t ? [new ValidationError(e.key, e.value, "property value must be a number or string")] : "number" !== t && "categorical" !== l ? [new ValidationError(e.key, e.value, "number expected, %s found", t)] : []
                }

                var o, n = e.valueSpec, l = unbundle(e.value.type), i = void 0 === e.value.property, u = void 0 !== e.value.property, s = "array" === getType(e.value.stops) && "array" === getType(e.value.stops[0]) && "object" === getType(e.value.stops[0][0]), p = validateObject({
                    key: e.key,
                    value: e.value,
        ...
        }, {"../error/validation_error": 163, "./validate_string": 185}],
        178: [function (require, module, exports) {
            ...
            "../util/unbundle_jsonlint": 168,
            "./validate_filter": 175,
            "./validate_layout_property": 179,
            "./validate_object": 182,
            "./validate_paint_property": 183
        }],
        179: [function (require, module, exports) {
            "use strict";
            var validate = require("./validate"), ValidationError = require("../error/validation_error");
            module.exports = function (e) {
                var r = e.key, t = e.style, a = e.styleSpec, i = e.value, l = e.objectKey, o = a["layout_" + e.layerType];
                if (!o)return [];
                if (e.valueSpec || o[l]) {
                    var s = [];
        ...
        }, {"../error/validation_error": 163, "./validate": 169}],
        ...
        182: [function (require, module, exports) {
            "use strict";
            var ValidationError = require("../error/validation_error"), getType = require("../util/get_type"), validateSpec = require("./validate");
            module.exports = function (e) {
                ...
                for (var p in t) {
                    var s, c = p.split(".")[0], d = i[c] || i["*"];
                    if (a[c]) s = a[c]; else if (i[c]) s = validateSpec; else if (a["*"]) s = a["*"]; else {
                        if (!i["*"]) {
        ...
        183: [function (require, module, exports) {
            ...
            var validate = require("./validate"), ValidationError = require("../error/validation_error");
            module.exports = function (e) {
                var r = e.key, a = e.style, t = e.styleSpec, i = e.value, l = e.objectKey, n = t["paint_" + e.layerType];
                if (!n)return [];
        ...
        186: [function (require, module, exports) {
            ...
            "../reference/latest.min": 188,
            "./validate/validate": 169,
            "./validate/validate_constants": 173,
            "./validate/validate_filter": 175,
            "./validate/validate_glyphs_url": 177,
            "./validate/validate_layer": 178,
            "./validate/validate_layout_property": 179,
            "./validate/validate_light": 180,
            "./validate/validate_paint_property": 183,
            "./validate/validate_source": 184
        }],
        187: [function (require, module, exports) {
            ...
            var baseIsEqual = require("lodash._baseisequal"), bindCallback = require("lodash._bindcallback");
            module.exports = isEqual;
        }, {"lodash._baseisequal": 152, "lodash._bindcallback": 153}],
        ...
        191: [function (require, module, exports) {
            (function (process) {
                ...
                exports.resolve = function () {
                    ...
                    for (var n = e(r.split("/")), s = e(t.split("/")), i = Math.min(n.length, s.length), o = i, u = 0; u < i; u++)if (n[u] !== s[u]) {
                        o = u;
                        break
                    }
        ...
        196: [function (require, module, exports) {
            ...
            function partialSort(a, t, r, o, p) {
                for (r = r || 0, o = o || a.length - 1, p = p || defaultCompare; o > r;) {
                    if (o - r > 600) {
                        var f = o - r + 1, e = t - r + 1, l = Math.log(f), s = .5 * Math.exp(2 * l / 3), i = .5 * Math.sqrt(l * s * (f - s) / f) * (e - f / 2 < 0 ? -1 : 1), n = Math.max(r, Math.floor(t - e * s / f + i)), h = Math.min(o, Math.floor(t + (f - e) * s / f + i));
        ...
        197: [function (require, module, exports) {
            !function (t, e) {
                ...
                return t.prototype.pack = function (t, e) {
                    t = [].concat(t), e = e || {};
                    for (var s, h, i, n = [], r = 0; r < t.length; r++)if (s = t[r].w || t[r].width, h = t[r].h || t[r].height, s && h) {
                    ...
                    var s = this.x;
                    return this.x += t, this.free -= t, {x: s, y: this.y, w: t, h: e, width: t, height: e}
        ...
        198: [function (require, module, exports) {
            ...
            module.exports = supercluster, SuperCluster.prototype = {
                options: {
                    ...
                    var n = this.trees[this._limitZoom(t)], r = Math.pow(2, t), i = this.options.extent, s = this.options.radius, u = s / i, a = (o - u) / r, h = (o + 1 + u) / r, l = {features: []};
        ...
        }, {"./support/isBuffer": 202, "_process": 195, "inherits": 201}],
        204: [function (require, module, exports) {
            module.exports.VectorTile = require("./lib/vectortile.js"), module.exports.VectorTileFeature = require("./lib/vectortilefeature.js"), module.exports.VectorTileLayer = require("./lib/vectortilelayer.js");
        }, {"./lib/vectortile.js": 205, "./lib/vectortilefeature.js": 206, "./lib/vectortilelayer.js": 207}],
        ...
        }, {"./lib/geojson_wrapper": 209, "./vector-tile-pb": 210, "pbf": 193}],
        ...
        }, {"point-geometry": 194, "vector-tile": 204}],
        ...
        213: [function (require, module, exports) {
            !function (e, t) {
                ...
                function r(e, t, o) {
                    var r = 2 * Math.PI * 6378137 / 256 / Math.pow(2, o), n = e * r - 2 * Math.PI * 6378137 / 2, i = t * r - 2 * Math.PI * 6378137 / 2;
                    return [n, i]
                }
