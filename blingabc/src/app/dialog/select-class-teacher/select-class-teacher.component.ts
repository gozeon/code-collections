...
@Component({
  selector: 'app-select-class-teacher',
  templateUrl: './select-class-teacher.component.html',
  styleUrls: ['./select-class-teacher.component.scss']
})
export class SelectClassTeacherComponent implements OnInit {
  // search
  searchTerm: string;
  ...
  constructor(private _classTeacherService: ClassTeacherService, private _toast: Md2Toast,
    public dialogRef: MatDialogRef<SelectClassTeacherComponent>, @Inject(MAT_DIALOG_DATA) public data: any) {
  }
