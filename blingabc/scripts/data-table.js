/**
 * @link https://github.com/Teradata/covalent/blob/develop/src/platform/core/data-table/data-table.component.ts#L426
 * @link https://github.com/Teradata/covalent/issues/1098
 */
        ...
        this._resizeSubs = this._onResize.asObservable().subscribe(function () {
            if (_this._rows) {
                _this._rows.toArray().forEach(function (row, index) {
                    _this._rowHeightCache[_this.fromRow + index] = row.height + 0.01;
                });
            }
