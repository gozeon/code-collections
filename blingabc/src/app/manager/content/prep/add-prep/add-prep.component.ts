...
@Component({
  selector: 'app-add-prep',
  templateUrl: './add-prep.component.html',
  styleUrls: ['./add-prep.component.scss']
})
export class AddPrepComponent implements OnInit {
  seasons: any[];
  levels: any[];
  selected = {
    tearmCode: '',
  ...
  onSubmit(): void {
    ...
    // TODO API
    this._prepService.createPreview(formData).subscribe(result => {
